...
class Proxy(proxy.Proxy):
    ...
    def get_message(self, queue_name, message):
        ...
        """
        message = self._get_resource(_message.Message, message, queue_name=queue_name)
        return self._get(_message.Message, message)

    def delete_message(self, queue_name, value, claim=None, ignore_missing=True):
        """Delete a message
        ...
        :returns: ``None``
        """
        message = self._get_resource(_message.Message, value, queue_name=queue_name)
        message.claim_id = resource.Resource._get_id(claim)
        return self._delete(_message.Message, message, ignore_missing=ignore_missing)
    ...
    def create_subscription(self, queue_name, **attrs):
        ...
        """
        return self._create(_subscription.Subscription, queue_name=queue_name, **attrs)
    ...
    def delete_subscription(self, queue_name, value, ignore_missing=True):
        ...
        :returns: ``None``
        """
        subscription = self._get_resource(_subscription.Subscription, value, queue_name=queue_name)
        return self._delete(
