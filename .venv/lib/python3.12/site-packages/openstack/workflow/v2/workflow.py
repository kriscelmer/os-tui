...
class Workflow(resource.Resource):
    ...
    _query_mapping = resource.QueryParameters("marker", "limit", "sort_keys", "sort_dirs", "fields")
    ...
    def create(
        ...
        **kwargs,
        ...
        kwargs = self._request_kwargs(prepend_key=prepend_key, base_path=base_path)
