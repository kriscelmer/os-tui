...
class Server(resource.Resource, metadata.MetadataMixin, tag.TagMixin):
    ...
    trusted_image_certificates = resource.Body("trusted_image_certificates", type=list)
    ...
    def migrate(self, session, *, host=None):
        ...
        if host and not utils.supports_microversion(session, "2.56"):
            raise ValueError("The 'host' option is only supported on microversion 2.56 or greater.")
