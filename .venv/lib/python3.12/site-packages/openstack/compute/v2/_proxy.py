...
class Proxy(proxy.Proxy):
    ...
    def get_keypair(self, keypair, user_id=None):
        ...
        return res.fetch(self, error_message=f"No Keypair found for {keypair}", **get_params)
    ...
    def unshelve_server(self, server, *, host=None, availability_zone=types.UNSET):
    ...
    def hypervisors(self, details=False, **query):
        ...
        if "hypervisor_hostname_pattern" in query and not utils.supports_microversion(self, "2.53"):
    ...
    def update_service_forced_down(
        ...
        if (not host or not binary) and (not service.host or not service.binary):
            raise ValueError(
                "Either service instance should have host and binary or they should be passed"
            )
    ...
    def update_service(self, service, **attrs):
        ...
        raise exceptions.SDKException("Method require at least microversion 2.53")
    ...
    def create_volume_attachment(self, server, volume=None, **attrs):
        ...
        if volume is None:
            ...
            if "volume_id" in attrs:
                ...
                raise TypeError(
                    "create_volume_attachment() missing 1 required positional argument: volume"
                )
    ...
    def get_quota_set_defaults(self, project):
        ...
        return res.fetch(self, base_path="/os-quota-sets/%(project_id)s/defaults")
        ...
        if "project_id" in attrs or isinstance(project, _quota_set.QuotaSet):
            ...
            if user is not None:
                raise exceptions.SDKException(
                    "The user argument can only be provided once the entire call has been updated."
                )
    ...
    def _get_cleanup_dependencies(self):
        return {"compute": {"before": ["block_storage", "network", "identity", "image"]}}
