...
class AbsoluteLimits(resource.Resource):
    ...
    security_group_rules = resource.Body("maxSecurityGroupRules", aka="max_security_group_rules")
    #: The maximum amount of security groups allowed.
    security_groups = resource.Body("maxSecurityGroups", aka="max_security_groups")
    ...
    floating_ips = resource.Body("maxTotalFloatingIps", aka="max_total_floating_ips")
    #: The amount of floating IPs currently in use.
    floating_ips_used = resource.Body("totalFloatingIpsUsed", aka="total_floating_ips_used")
    ...
    instances_used = resource.Body("totalInstancesUsed", aka="total_instances_used")
    ...
    server_groups_used = resource.Body("totalServerGroupsUsed", aka="total_server_groups_used")
    #: The maximum number of members in a server group.
    server_group_members = resource.Body("maxServerGroupMembers", aka="max_server_group_members")
