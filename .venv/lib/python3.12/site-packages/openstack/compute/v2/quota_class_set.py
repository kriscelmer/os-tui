...
class QuotaClassSet(resource.Resource):
    ...
    injected_file_content_bytes = resource.Body("injected_file_content_bytes", type=int)
    #: The number of allowed bytes for each injected file path.
    injected_file_path_bytes = resource.Body("injected_file_path_bytes", type=int)
