...
class Backup(resource.Resource, metadata.MetadataMixin):
    ...
    def create(self, session, prepend_key=True, base_path=None, **params):
        ...
        if self.create_method == "POST":
            ...
            if "is_incremental" in body["backup"]:
                body["backup"]["incremental"] = body["backup"].pop("is_incremental")
    ...
    def _action(self, session, body, microversion=None):
        ...
        resp = session.post(url, json=body, microversion=self._max_microversion)
    ...
    def restore(self, session, volume_id=None, name=None):
        ...
        if not (volume_id or name):
            raise exceptions.SDKException("Either of `name` or `volume_id` must be specified.")
    ...
    def reset(self, session, status):
        warnings.warn(
            "reset is a deprecated alias for reset_status and will be removed in a future release.",
