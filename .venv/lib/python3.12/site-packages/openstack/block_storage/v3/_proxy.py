...
class Proxy(proxy.Proxy):
    ...
    def delete_snapshot(self, snapshot, ignore_missing=True, force=False):
        ...
        """
        if not force:
            self._delete(_snapshot.Snapshot, snapshot, ignore_missing=ignore_missing)
        else:
    ...
    def create_type_encryption(self, volume_type, **attrs):
        ...
        return self._create(_type.TypeEncryption, volume_type_id=volume_type.id, **attrs)

    def delete_type_encryption(self, encryption=None, volume_type=None, ignore_missing=True):
        ...
        self._delete(_type.TypeEncryption, encryption, ignore_missing=ignore_missing)
    ...
    def default_types(self):
        ...
        if not utils.supports_microversion(self, "3.67"):
            raise exceptions.SDKException("List default types require at least microversion 3.67")
    ...
    def show_default_type(self, project):
        ...
        # URL with project ID
        if not utils.supports_microversion(self, "3.67"):
            raise exceptions.SDKException("Show default type require at least microversion 3.67")
    ...
    def set_default_type(self, project, type):
        ...
        # URL with project ID
        if not utils.supports_microversion(self, "3.67"):
            raise exceptions.SDKException("Set default type require at least microversion 3.67")
    ...
    def unset_default_type(self, project):
        ...
        # URL with project ID
        if not utils.supports_microversion(self, "3.67"):
            raise exceptions.SDKException("Unset default type require at least microversion 3.67")
    ...
    def delete_volume(self, volume, ignore_missing=True, *, force=False, cascade=False):
        """Delete a volume
    ...
    def reset_volume_status(self, volume, status=None, attach_status=None, migration_status=None):
    ...
    def reset_group_snapshot_status(self, group_snapshot, status):
        ...
        :returns: None
        """
        resource = self._get_resource(_group_snapshot.GroupSnapshot, group_snapshot)
    ...
    def update_quota_class_set(self, quota_class_set, **attrs):
        ...
        """
        return self._update(_quota_class_set.QuotaClassSet, quota_class_set, **attrs)
    ...
    def get_quota_set_defaults(self, project):
        ...
        project = self._get_resource(_project.Project, project)
        res = self._get_resource(_quota_set.QuotaSet, None, project_id=project.id)
        return res.fetch(self, base_path=(f"/os-quota-sets/{project.id}/defaults"))
    ...
    def update_quota_set(self, project, **attrs):
        ...
        if "project_id" in attrs or isinstance(project, _quota_set.QuotaSet):
            ...
            if "query" in attrs:
                warnings.warn(
                    "The query argument is no longer supported and should be removed.",
                    os_warnings.RemovedInSDK50Warning,
                )
                attrs.pop("query")
    ...
    def get_service_log_levels(
        ...
        *,
        ...
        """
        return _service.Service.get_log_levels(self, binary=binary, server=server, prefix=prefix)
    ...
    def failover_service(
        ...
        *,
        ...
        """
        service_obj = self._get_resource(_service.Service, service)
        return service_obj.failover(self, cluster=cluster, backend_id=backend_id)
        ...
        if not self.should_skip_resource_cleanup("backup", skip_resources):
            if dry_run:
                ...
                while need_backup_iteration and max_iterations > 0:
                    ...
                    for obj in self.backups(details=True, sort_key="created_at", sort_dir="desc"):
