...
class Volume(resource.Resource, metadata.MetadataMixin):
    ...
    extended_replication_status = resource.Body("os-volume-replication:extended_status")
    ...
    replication_driver_data = resource.Body("os-volume-replication:driver_data")
    ...
    def reset_status(self, session, status=None, attach_status=None, migration_status=None):
    ...
    def attach(self, session, mountpoint, instance=None, host_name=None):
        ...
        if instance is not None:
            ...
            raise ValueError("Either instance_uuid or host_name must be specified")
    ...
    def _prepare_request_body(self, patch, prepend_key, *, resource_request_key=None):
