...
class Proxy(proxy.Proxy):
    ...
    def delete_zone_import(self, zone_import, ignore_missing=True):
        ...
        :returns: None
        """
        return self._delete(_zone_import.ZoneImport, zone_import, ignore_missing=ignore_missing)
    ...
    def delete_tsigkey(self, tsigkey, ignore_missing=True, delete_shares=False):
        """Delete a TSIG key
    ...
    def find_tsigkey(self, name_or_id, ignore_missing=True):
        ...
        """
        return self._find(_tsigkey.TSIGKey, name_or_id, ignore_missing=ignore_missing)
