...
class MetadataMixin:
    ...
    def get_metadata_item(self, session: resource.AdapterT, key: str) -> ty_ext.Self:
    ...
    def set_metadata_item(self, session: resource.AdapterT, key: str, value: ty.Any) -> ty_ext.Self:
    ...
    def delete_metadata_item(self, session: resource.AdapterT, key: str) -> ty_ext.Self:
