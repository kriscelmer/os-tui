...
class Network(_base.NetworkResource, _base.TagMixinNetwork):
    ...
    is_port_security_enabled = resource.Body("port_security_enabled", type=bool, default=False)
    #: Whether or not the router is external.
    #: *Type: bool* *Default: False*
    is_router_external = resource.Body("router:external", type=bool, default=False)
