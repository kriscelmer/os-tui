...
class TestDomain(base.TestCase):
    ...
    def test_assign_role_to_user_good(self):
        ...
        self.assertTrue(
            sot.assign_role_to_user(self.sess, user.User(id="1"), role.Role(id="2"), False)
        )
    ...
    def test_assign_inherited_role_to_user_good(self):
        ...
        self.assertTrue(
            sot.assign_role_to_user(self.sess, user.User(id="1"), role.Role(id="2"), True)
        )
    ...
    def test_validate_user_has_role_good(self):
        ...
        self.assertTrue(
            sot.validate_user_has_role(self.sess, user.User(id="1"), role.Role(id="2"), False)
        )
    ...
    def test_validate_user_has_inherited_role_good(self):
        ...
        self.assertTrue(
            sot.validate_user_has_role(self.sess, user.User(id="1"), role.Role(id="2"), True)
        )
    ...
    def test_unassign_role_from_user_good(self):
        ...
        self.assertTrue(
            sot.unassign_role_from_user(self.sess, user.User(id="1"), role.Role(id="2"), False)
        )

        self.sess.delete.assert_called_with("domains/IDENTIFIER/users/1/roles/2")
    ...
    def test_unassign_inherited_role_from_user_good(self):
        ...
        self.assertTrue(
            sot.unassign_role_from_user(self.sess, user.User(id="1"), role.Role(id="2"), True)
        )
    ...
    def test_assign_role_to_group_good(self):
        ...
        self.assertTrue(
            sot.assign_role_to_group(self.sess, group.Group(id="1"), role.Role(id="2"), False)
        )
    ...
    def test_assign_inherited_role_to_group_good(self):
        ...
        self.assertTrue(
            sot.assign_role_to_group(self.sess, group.Group(id="1"), role.Role(id="2"), True)
        )
    ...
    def test_validate_group_has_role_good(self):
        ...
        self.assertTrue(
            sot.validate_group_has_role(self.sess, group.Group(id="1"), role.Role(id="2"), False)
        )

        self.sess.head.assert_called_with("domains/IDENTIFIER/groups/1/roles/2")
    ...
    def test_validate_group_has_inherited_role_good(self):
        ...
        self.assertTrue(
            sot.validate_group_has_role(self.sess, group.Group(id="1"), role.Role(id="2"), True)
        )
    ...
    def test_unassign_role_from_group_good(self):
        ...
        self.assertTrue(
            sot.unassign_role_from_group(self.sess, group.Group(id="1"), role.Role(id="2"), False)
        )
    ...
    def test_unassign_inherited_role_from_group_good(self):
        ...
        self.assertTrue(
            sot.unassign_role_from_group(self.sess, group.Group(id="1"), role.Role(id="2"), True)
        )
