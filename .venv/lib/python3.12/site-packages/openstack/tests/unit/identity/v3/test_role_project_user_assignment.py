...
class TestRoleProjectUserAssignment(base.TestCase):
    def test_basic(self):
        ...
        self.assertEqual("/projects/%(project_id)s/users/%(user_id)s/roles", sot.base_path)
        self.assertTrue(sot.allow_list)

    def test_make_it(self):
        sot = role_project_user_assignment.RoleProjectUserAssignment(**EXAMPLE)
