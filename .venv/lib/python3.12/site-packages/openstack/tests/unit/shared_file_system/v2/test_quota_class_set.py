...
class TestQuotaClassSet(base.TestCase):
    ...
    def test_get_quota_class_set(self):
        ...
        self.assertEqual(EXAMPLE["share_groups"], _quota_class_set.share_groups)
        ...
        self.assertEqual(EXAMPLE["snapshot_gigabytes"], _quota_class_set.snapshot_gigabytes)
        self.assertEqual(EXAMPLE["shares"], _quota_class_set.shares)
        self.assertEqual(EXAMPLE["id"], _quota_class_set.id)
        self.assertEqual(EXAMPLE["share_networks"], _quota_class_set.share_networks)
        self.assertEqual(EXAMPLE["share_replicas"], _quota_class_set.share_replicas)
        self.assertEqual(EXAMPLE["replica_gigabytes"], _quota_class_set.replica_gigabytes)
        self.assertEqual(
            EXAMPLE["per_share_gigabytes"],
            _quota_class_set.per_share_gigabytes,
        )
        self.assertEqual(EXAMPLE["backups"], _quota_class_set.backups)
        self.assertEqual(EXAMPLE["backup_gigabytes"], _quota_class_set.backup_gigabytes)
    ...
    def test_update_quota_class_set(self):
        ...
        self.assertEqual(updated_attributes["share_groups"], _quota_class_set.share_groups)
        self.assertEqual(updated_attributes["gigabytes"], _quota_class_set.gigabytes)
        self.assertEqual(
