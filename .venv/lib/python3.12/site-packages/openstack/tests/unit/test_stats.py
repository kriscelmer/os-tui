...
class TestStats(base.TestCase):
    def setUp(self):
        ...
        self.useFixture(fixtures.EnvironmentVariable("STATSD_PORT", str(self.statsd.port)))
    ...
    def test_list_projects(self):
        ...
        self.assert_reported_stat("openstack.api.identity.GET.projects.200", value="1", kind="c")
    ...
    def test_servers_no_detail(self):
        ...
        self.assert_reported_stat("openstack.api.compute.GET.servers.200", value="5", kind="ms")
        self.assert_reported_stat(
    ...
    def test_servers_error(self):
        ...
        self.assert_reported_stat("openstack.api.compute.GET.servers.500", value="1", kind="c")
        self.assert_reported_stat("openstack.api.compute.GET.servers.500", value="5", kind="ms")
        self.assert_reported_stat(
            "openstack.api.compute.GET.servers.attempted", value="1", kind="c"
        )
        self.assert_prometheus_stat(
    ...
    def test_timeout(self):
        ...
        self.register_uris([dict(method="GET", uri=mock_uri, exc=rexceptions.ConnectTimeout)])
        ...
        self.assert_reported_stat("openstack.api.compute.GET.servers.failed", value="1", kind="c")
        self.assert_reported_stat(
            "openstack.api.compute.GET.servers.attempted", value="1", kind="c"
        )
