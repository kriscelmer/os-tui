...
class TestUsers(base.TestCase):
    ...
    def test_delete_user(self):
        ...
        self.register_uris(
            [
                ...
                dict(
                    method="GET",
                    uri=self._get_keystone_mock_url(resource="users", append=[user_data.name]),
                    status_code=404,
                ),
                dict(
                    method="GET",
    ...
    def test_delete_user_not_found(self):
        ...
        self.register_uris(
            [
                dict(
                    method="GET",
                    uri=self._get_keystone_mock_url(resource="users", append=[nonexistent_user_id]),
                    status_code=404,
                ),
                dict(
                    method="GET",
    ...
    def test_add_user_to_group(self):
        ...
        self.register_uris(
            [
                dict(
                    method="GET",
                    uri=self._get_keystone_mock_url(resource="users", append=[user_data.user_id]),
                    status_code=200,
                    json=user_data.json_response,
                ),
                dict(
    ...
    def test_remove_user_from_group(self):
        ...
        self.cloud.remove_user_from_group(user_data.user_id, group_data.group_id)
        self.assert_calls()
