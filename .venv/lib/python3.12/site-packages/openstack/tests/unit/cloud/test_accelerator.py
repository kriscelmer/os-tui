...
ARQ_ATTACH_INFO_STR = '{"bus": "5e", "device": "00", "domain": "0000", "function": "1"}'
ARQ_DICT = {
    "uuid": ARQ_UUID,
    ...
    def test_list_deployables(self):
        self.register_uris(
            [
                dict(
                    method="GET",
                    uri=self.get_mock_url("accelerator", "public", append=["v2", "deployables"]),
    ...
    def test_list_devices(self):
        self.register_uris(
            [
                dict(
                    method="GET",
                    uri=self.get_mock_url("accelerator", "public", append=["v2", "devices"]),
