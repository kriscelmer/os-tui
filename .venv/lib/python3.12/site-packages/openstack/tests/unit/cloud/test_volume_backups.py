...
class TestVolumeBackups(base.TestCase):
    ...
    def test_search_volume_backups(self):
        ...
        self.register_uris(
            [
                dict(
                    method="GET",
                    uri=self.get_mock_url("volumev3", "public", append=["backups", "detail"]),
    ...
    def test_get_volume_backup(self):
        ...
        self.register_uris(
            [
                dict(
                    method="GET",
                    uri=self.get_mock_url("volumev3", "public", append=["backups", name]),
                    status_code=404,
                ),
                dict(
                    method="GET",
    ...
    def test_get_volume_backup_with_filters(self):
        ...
        result = self.cloud.get_volume_backup(name, {"availability_zone": "az1"})
    ...
    def test_delete_volume_backup_wait(self):
        ...
        self.register_uris(
            [
                dict(
                    method="GET",
                    uri=self.get_mock_url("volumev3", "public", append=["backups", backup_id]),
                    json={"backup": backup},
                ),
                dict(
                    method="DELETE",
    ...
    def test_create_volume_backup(self):
        ...
        self.register_uris(
            [
                dict(
                    method="POST",
                    uri=self.get_mock_url("volumev3", "public", append=["backups"]),
                    json={"backup": bak1},
                    validate=dict(
                        json={
                            "backup": {
