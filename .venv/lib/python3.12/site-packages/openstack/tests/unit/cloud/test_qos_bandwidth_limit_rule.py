...
class TestQosBandwidthLimitRule(base.TestCase):
    ...
    qos_bw_limit_direction_extension = {
        ...
        "description": (
            "Allow to configure QoS bandwidth limit rule with specific direction: ingress or egress"
        ),
    }
    ...
    def _compare_rules(self, exp, real):
        self.assertDictEqual(
            qos_bandwidth_limit_rule.QoSBandwidthLimitRule(**exp).to_dict(computed=False),
    ...
    def test_get_qos_bandwidth_limit_rule(self):
        ...
        r = self.cloud.get_qos_bandwidth_limit_rule(self.policy_name, self.rule_id)
        ...
        self.register_uris(
            [
                ...
                dict(
                    ...
                    validate=dict(
                        json={"bandwidth_limit_rule": {"max_kbps": self.rule_max_kbps + 100}}
                    ),
                ),
            ]
        )
    ...
    def test_delete_qos_bandwidth_limit_rule(self):
        ...
        self.assertTrue(self.cloud.delete_qos_bandwidth_limit_rule(self.policy_name, self.rule_id))
        self.assert_calls()
    ...
    def test_delete_qos_bandwidth_limit_rule_not_found(self):
        ...
        self.assertFalse(self.cloud.delete_qos_bandwidth_limit_rule(self.policy_name, self.rule_id))
        self.assert_calls()
