...
class TestVolumeAccess(base.TestCase):
    ...
    def test_list_volume_types(self):
        ...
        self.register_uris(
            [
                dict(
                    method="GET",
                    uri=self.get_mock_url("volumev3", "public", append=["types"]),
    ...
    def test_remove_volume_type_access(self):
        ...
        self.register_uris(
            [
                ...
                dict(
                    ...
                    json={"removeProjectAccess": {"project": project_001["project_id"]}},
                    validate=dict(
                        json={"removeProjectAccess": {"project": project_001["project_id"]}}
                    ),
                ),
        ...
        self.assertEqual(len(self.cloud.get_volume_type_access(volume_type["name"])), 2)
        self.cloud.remove_volume_type_access(volume_type["name"], project_001["project_id"])
        self.assertEqual(len(self.cloud.get_volume_type_access(volume_type["name"])), 1)
        self.assert_calls()
        ...
        self.register_uris(
            [
                ...
                dict(
                    ...
                    json={"addProjectAccess": {"project": project_002["project_id"]}},
                    validate=dict(
                        json={"addProjectAccess": {"project": project_002["project_id"]}}
                    ),
                ),
    ...
    def test_add_volume_type_access_missing(self):
        ...
        self.register_uris(
            [
                ...
                dict(
                    method="GET",
                    uri=self.get_mock_url("volumev3", "public", append=["types", "MISSING"]),
                    status_code=404,
                ),
                dict(
                    method="GET",
