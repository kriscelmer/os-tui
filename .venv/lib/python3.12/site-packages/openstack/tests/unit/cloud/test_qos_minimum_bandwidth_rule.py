...
class TestQosMinimumBandwidthRule(base.TestCase):
    ...
    def _compare_rules(self, exp, real):
        self.assertDictEqual(
            qos_minimum_bandwidth_rule.QoSMinimumBandwidthRule(**exp).to_dict(computed=False),
    ...
    def test_get_qos_minimum_bandwidth_rule(self):
        ...
        r = self.cloud.get_qos_minimum_bandwidth_rule(self.policy_name, self.rule_id)
        ...
        self.register_uris(
            [
                ...
                dict(
                    ...
                    validate=dict(
                        json={"minimum_bandwidth_rule": {"min_kbps": self.rule_min_kbps + 100}}
                    ),
                ),
            ]
        )
    ...
    def test_delete_qos_minimum_bandwidth_rule(self):
        ...
        self.assertTrue(
            self.cloud.delete_qos_minimum_bandwidth_rule(self.policy_name, self.rule_id)
        )
        self.assert_calls()
