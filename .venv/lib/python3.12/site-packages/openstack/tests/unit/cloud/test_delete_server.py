    ...
    def test_delete_server(self):
        ...
        self.register_uris(
            [
                ...
                dict(
                    method="GET",
                    uri=self.get_mock_url("compute", "public", append=["servers", "daffy"]),
                    status_code=404,
                ),
                dict(
                    method="GET",
                ...
                dict(
                    method="DELETE",
                    uri=self.get_mock_url("compute", "public", append=["servers", "1234"]),
                ),
            ]
        )
    ...
    def test_delete_server_already_gone(self):
        ...
        self.register_uris(
            [
                ...
                dict(
                    method="GET",
                    uri=self.get_mock_url("compute", "public", append=["servers", "tweety"]),
                    status_code=404,
                ),
                dict(
                    method="GET",
    ...
    def test_delete_server_already_gone_wait(self):
        self.register_uris(
            [
                ...
                dict(
                    method="GET",
                    uri=self.get_mock_url("compute", "public", append=["servers", "speedy"]),
                    status_code=404,
                ),
                dict(
                    method="GET",
    ...
    def test_delete_server_wait_for_deleted(self):
        ...
        self.register_uris(
            [
                ...
                dict(
                    method="GET",
                    uri=self.get_mock_url("compute", "public", append=["servers", "wily"]),
                    status_code=404,
                ),
                dict(
                    method="GET",
                ...
                dict(
                    method="DELETE",
                    uri=self.get_mock_url("compute", "public", append=["servers", "9999"]),
                ),
                dict(
                    method="GET",
                    uri=self.get_mock_url("compute", "public", append=["servers", "9999"]),
    ...
    def test_delete_server_fails(self):
        ...
        self.register_uris(
            [
                ...
                dict(
                    method="DELETE",
                    uri=self.get_mock_url("compute", "public", append=["servers", "1212"]),
                    status_code=400,
                ),
            ]
        )
    ...
    def test_delete_server_no_cinder(self):
        ...
        self.register_uris(
            [
                ...
                dict(
                    method="GET",
                    uri=self.get_mock_url("compute", "public", append=["servers", "porky"]),
                    status_code=404,
                ),
                dict(
                    method="GET",
    ...
    def test_delete_server_delete_fips_nova(self):
        ...
        self.register_uris(
            [
                ...
                dict(
                    method="DELETE",
                    uri=self.get_mock_url("compute", "public", append=["os-floating-ips", "1"]),
                ),
                dict(
                    method="GET",
                    uri=self.get_mock_url("compute", "public", append=["os-floating-ips"]),
