...
class TestCreateServer(base.TestCase):
    ...
    def test_create_server_with_get_exception(self):
        ...
        self.register_uris(
            [
                ...
                dict(
                    method="POST",
                    uri=self.get_mock_url("compute", "public", append=["servers"]),
    ...
    def test_wait_for_server(self, mock_get_server, mock_get_active_server):
        ...
        mock_get_active_server.side_effect = iter([building_server, active_server])
    ...
    def test_create_boot_attach_volume(self):
        ...
        self.register_uris(
            [
                ...
                dict(
                    method="GET",
                    uri=self.get_mock_url("volumev3", "public", append=["volumes", volume_id]),
                    json={
                        "volume": {
                            "id": volume_id,
                            "status": "available",
