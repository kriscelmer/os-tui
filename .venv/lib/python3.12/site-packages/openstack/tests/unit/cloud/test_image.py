...
class TestImage(BaseTestImage):
    ...
    def test_get_image_name(self, cloud=None):
        ...
        self.register_uris(
            [
                dict(
                    method="GET",
                    uri=self.get_mock_url("image", append=["images"], base_url_append="v2"),
                    json=self.fake_search_return,
                ),
                dict(
                    method="GET",
        ...
        self.assertEqual(self.image_name, cloud.get_image_name(self.image_name))
    ...
    def test_list_images_show_all(self):
        ...
        [
            self._compare_images(a, b)
            for a, b in zip([self.fake_image_dict], self.cloud.list_images(show_all=True))
        ]
        self.assert_calls()
    ...
    def test_create_image_task(self):
        ...
        self.register_uris(
            [
                ...
                dict(
                    method="POST",
                    uri=self.get_mock_url("image", append=["tasks"], base_url_append="v2"),
                    ...
                    validate=dict(
                        json=sorted(
                            [
                                ...
                                {
                                    "op": "add",
                                    "value": self.fake_image_dict["owner_specified.openstack.md5"],
            ...
            [
                ...
                dict(
                    ...
                    headers={
                        ...
                        "Accept-Ranges": "bytes",
                        "Content-Type": "application/octet-stream",
                        ("X-Object-Meta-" + self.cloud._OBJECT_AUTOCREATE_KEY): "true",
                        "Etag": fakes.NO_MD5,
    ...
    def test_create_image_put_v1(self):
        ...
        self.register_uris(
            [
                ...
                dict(
                    method="GET",
                    uri="https://image.example.com/v1/images/detail?name=" + self.image_name,
                    json={"images": []},
                ),
                dict(
                    method="POST",
    ...
    def test_create_image_put_meta_int(self):
        ...
        self._call_create_image(self.image_name, min_disk="0", min_ram=0, meta={"int_v": 12345})
