...
class TestQosDscpMarkingRule(base.TestCase):
    ...
    def _compare_rules(self, exp, real):
        self.assertDictEqual(
            qos_dscp_marking_rule.QoSDSCPMarkingRule(**exp).to_dict(computed=False),
        ...
        self.register_uris(
            [
                ...
                dict(
                    ...
                    validate=dict(json={"dscp_marking_rule": {"dscp_mark": new_dscp_mark_value}}),
                ),
            ]
        )
    ...
    def test_delete_qos_dscp_marking_rule(self):
        ...
        self.assertTrue(self.cloud.delete_qos_dscp_marking_rule(self.policy_name, self.rule_id))
        self.assert_calls()
    ...
    def test_delete_qos_dscp_marking_rule_not_found(self):
        ...
        self.assertFalse(self.cloud.delete_qos_dscp_marking_rule(self.policy_name, self.rule_id))
        self.assert_calls()
