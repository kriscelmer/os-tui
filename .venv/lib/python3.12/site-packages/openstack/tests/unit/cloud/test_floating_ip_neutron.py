...
class TestFloatingIP(base.TestCase):
    ...
    def test_list_floating_ips_with_filters(self):
        self.register_uris(
            [
                dict(
                    method="GET",
                    uri=("https://network.example.com/v2.0/floatingips?description=42"),
                    json={"floatingips": []},
                )
            ]
        )
    ...
    def test_search_floating_ips(self):
        ...
        floating_ips = self.cloud.search_floating_ips(filters={"updated_at": "never"})
    ...
    def test_get_floating_ip(self):
        ...
        floating_ip = self.cloud.get_floating_ip(id="2f245a7b-796b-4f26-9cf9-9e82d248fda7")
    ...
    def test_create_floating_ip(self):
        self.register_uris(
            [
                ...
                dict(
                    method="GET",
                    uri="https://network.example.com/v2.0/networks?name=my-network",
                ...
                dict(
                    ...
                    uri="https://network.example.com/v2.0/floatingips",
                    json=self.mock_floating_ip_new_rep,
                    validate=dict(json={"floatingip": {"floating_network_id": "my-network-id"}}),
                ),
            ]
        )
    ...
    def test_available_floating_ip_new(self):
        self.register_uris(
            [
                dict(
                    method="GET",
                    uri=self.get_mock_url("network", "public", append=["v2.0", "networks"]),
                    json={"networks": [self.mock_get_network_rep]},
                ),
                dict(
                    method="GET",
                    uri=self.get_mock_url("network", "public", append=["v2.0", "subnets"]),
                    json={"subnets": []},
                ),
                dict(
                    method="GET",
                    uri=self.get_mock_url("network", "public", append=["v2.0", "floatingips"]),
                    json={"floatingips": []},
                ),
                dict(
                    method="POST",
    ...
    def test_delete_floating_ip_existing(self):
        ...
        self.assertTrue(self.cloud.delete_floating_ip(floating_ip_id=fip_id, retry=2))
        self.assert_calls()
    ...
    def test_delete_floating_ip_not_found(self):
        self.register_uris(
            [
                dict(
                    method="DELETE",
                    uri=("https://network.example.com/v2.0/floatingips/a-wild-id-appears"),
                    status_code=404,
                )
            ]
        )
        ...
        self.register_uris(
            [
                ...
                dict(
                    ...
                    json={"floatingip": self.mock_floating_ip_list_rep["floatingips"][0]},
                    validate=dict(
                        json={
                            "floatingip": {
                                "port_id": self.mock_search_ports_rep[0]["id"],
                                "fixed_ip_address": self.mock_search_ports_rep[0]["fixed_ips"][0][
                                    "ip_address"
                                ],
                            }
                        }
    ...
    def test_detach_ip_from_server(self):
        ...
        self.cloud.detach_ip_from_server(server_id="server-id", floating_ip_id=fip["id"])
        self.assert_calls()
        ...
        self.register_uris(
            [
                ...
                dict(
                    ...
                    uri=self.get_mock_url("network", "public", append=["v2.0", "floatingips"]),
                    json={"floatingip": fip},
                    validate=dict(json={"floatingip": {"floating_network_id": network["id"]}}),
                ),
                dict(
                    method="GET",
                    uri=self.get_mock_url(
                        ...
                        "public",
                        append=["v2.0", "ports"],
                        qs_elements=["device_id={}".format(self.fake_server["id"])],
                    ),
                    json={"ports": self.mock_search_ports_rep},
                ),
                dict(
    ...
    def test_create_floating_ip_no_port(self):
        server_port = {
            ...
            "created_at": datetime.datetime.now().isoformat(),
            "fixed_ips": [{"subnet_id": "subnet-id", "ip_address": "172.24.4.2"}],
        }
                        ...
                        "subnets": [
                            {
                                ...
                                "gateway_ip": "10.4.0.1",
                                "ipv6_ra_mode": None,
                                "allocation_pools": [{"start": "10.4.0.2", "end": "10.4.0.200"}],
                                "host_routes": [],
                                "ip_version": 4,
