...
class TestQosRuleType(base.TestCase):
    ...
    qos_rule_type_details_extension = {
        ...
        "description": ("Expose details about QoS rule types supported by loaded backend drivers"),
    }
    ...
    def test_list_qos_rule_types_no_qos_extension(self):
        ...
        self.assertRaises(exceptions.SDKException, self.cloud.list_qos_rule_types)
        self.assert_calls()
