...
class TestVolume(base.TestCase):
        ...
        self.register_uris(
            [
                ...
                dict(
                    ...
                    validate=dict(json={"volumeAttachment": {"volumeId": vol["id"]}}),
                ),
            ]
        )
    ...
    def test_attach_volume_wait(self):
        ...
        volume = meta.obj_to_munch(fakes.FakeVolume(**vol))
        vol["attachments"] = [{"server_id": server["id"], "device": "device001"}]
        vol["status"] = "in-use"
        ...
        self.register_uris(
            [
                ...
                dict(
                    method="GET",
                    uri=self.get_mock_url("volumev3", "public", append=["volumes", vol["id"]]),
                    json={"volume": volume},
                ),
                dict(
                    method="GET",
    ...
    def test_attach_volume_wait_error(self):
        ...
        self.register_uris(
            [
                ...
                dict(
                    method="GET",
                    uri=self.get_mock_url("volumev3", "public", append=["volumes", volume["id"]]),
    ...
    def test_get_volume_by_id(self):
        ...
        self.register_uris(
            [
                ...
                dict(
                    method="GET",
                    uri=self.get_mock_url("volumev3", "public", append=["volumes", "01"]),
                    json={"volume": vol1},
                ),
            ]
        )
    ...
    def test_create_volume(self):
        ...
        self.register_uris(
            [
                ...
                dict(
                    method="POST",
                    uri=self.get_mock_url("volumev3", "public", append=["volumes"]),
                    json={"volume": vol1},
                    validate=dict(
                        json={
                            "volume": {
        ...
        self.register_uris(
            [
                ...
                dict(
                    ...
                    validate=dict(json={"os-set_bootable": {"bootable": True}}),
                ),
            ]
        )
