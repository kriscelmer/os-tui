...
class TestFloatingIP(base.TestCase):
    ...
    def test_get_floating_ip_by_id(self):
        self.register_uris(
            [
                dict(
                    method="GET",
                    uri=self.get_mock_url("compute", append=["os-floating-ips", "1"]),
    ...
    def test_create_floating_ip(self):
        self.register_uris(
            [
                ...
                dict(
                    method="GET",
                    uri=self.get_mock_url("compute", append=["os-floating-ips", "2"]),
                    json={"floating_ip": self.mock_floating_ip_list_rep[1]},
                ),
            ]
        )
    ...
    def test_attach_ip_to_server(self):
        ...
        self.cloud._attach_ip_to_server(
            ...
            floating_ip=self.cloud._normalize_floating_ip(self.mock_floating_ip_list_rep[0]),
            fixed_address="192.0.2.129",
        )
