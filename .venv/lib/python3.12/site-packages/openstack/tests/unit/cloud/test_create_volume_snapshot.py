...
class TestCreateVolumeSnapshot(base.TestCase):
    ...
    def test_create_volume_snapshot_wait(self):
        ...
        fake_snapshot = fakes.FakeVolumeSnapshot(snapshot_id, "available", "foo", "derpysnapshot")
        ...
        self.register_uris(
            [
                dict(
                    ...
                    validate=dict(json={"snapshot": {"volume_id": "1234", "force": False}}),
                ),
                dict(
                    method="GET",
                    uri=self.get_mock_url("volumev3", "public", append=["snapshots", snapshot_id]),
                    json={"snapshot": build_snapshot_dict},
                ),
                dict(
                    method="GET",
