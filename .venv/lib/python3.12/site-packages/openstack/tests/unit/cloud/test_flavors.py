...
class TestFlavors(base.TestCase):
    ...
    def test_get_flavor_string_and_int(self):
        self.use_compute_discovery()
        flavor_resource_uri = f"{fakes.COMPUTE_ENDPOINT}/flavors/1/os-extra_specs"
        ...
        self.register_uris(
            [
                dict(
                    ...
                    json={"flavor_access": []},
                    validate=dict(json={"removeTenantAccess": {"tenant": "tenant_id"}}),
                )
            ]
        )
        ...
        self.register_uris(
            [
                dict(
                    ...
                    json={"flavor_access": [{"flavor_id": "vanilla", "tenant_id": "tenant_id"}]},
                )
            ]
        )
