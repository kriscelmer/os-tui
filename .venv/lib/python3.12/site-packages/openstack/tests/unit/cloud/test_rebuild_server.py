...
class TestRebuildServer(base.TestCase):
    def setUp(self):
        ...
        self.rebuild_server = fakes.make_fake_server(self.server_id, self.server_name, "REBUILD")
        self.error_server = fakes.make_fake_server(self.server_id, self.server_name, "ERROR")
        ...
        self.register_uris(
            [
                ...
                dict(
                    ...
                    status_code=400,
                    validate=dict(json={"rebuild": {"imageRef": "a", "adminPass": "b"}}),
                ),
            ]
        )
    ...
    def test_rebuild_server_server_error(self):
        ...
        self.register_uris(
            [
                ...
                dict(
                    method="GET",
                    uri=self.get_mock_url("compute", "public", append=["servers", self.server_id]),
    ...
    def test_rebuild_server_with_admin_pass_no_wait(self):
        ...
        self.register_uris(
            [
                ...
                dict(
                    ...
                    validate=dict(json={"rebuild": {"imageRef": "a", "adminPass": password}}),
                ),
                dict(
                    method="GET",
                    uri=self.get_mock_url("network", "public", append=["v2.0", "networks"]),
        ...
        self.assertEqual(
            password,
            self.cloud.rebuild_server(self.fake_server["id"], "a", admin_pass=password)[
                "adminPass"
            ],
        )
    ...
    def test_rebuild_server_with_admin_pass_wait(self):
        ...
        self.assertEqual(
            password,
            self.cloud.rebuild_server(self.fake_server["id"], "a", admin_pass=password, wait=True)[
                "adminPass"
            ],
        )
    ...
    def test_rebuild_server_wait(self):
        ...
        self.assertEqual(
            "ACTIVE",
            self.cloud.rebuild_server(self.fake_server["id"], "a", wait=True)["status"],
        )
