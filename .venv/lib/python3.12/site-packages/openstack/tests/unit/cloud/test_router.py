...
class TestRouter(base.TestCase):
    ...
    def test_create_router(self):
        self.register_uris(
            [
                dict(
                    method="POST",
                    uri=self.get_mock_url("network", "public", append=["v2.0", "routers"]),
    ...
    def test_remove_router_interface(self):
        ...
        self.cloud.remove_router_interface({"id": self.router_id}, subnet_id=self.subnet_id)
        self.assert_calls()
    ...
    router = {
        ...
        "external_gateway_info": {
            "external_fixed_ips": [{"subnet_id": "external_subnet_id", "ip_address": "1.2.3.4"}]
        },
    }
    ...
    def test_list_router_interfaces_internal(self):
        self._test_list_router_interfaces(self.router, interface_type="internal")

    def test_list_router_interfaces_external(self):
        self._test_list_router_interfaces(self.router, interface_type="external")
