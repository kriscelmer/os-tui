...
class TestBaremetalNode(base.IronicTestCase):
        ...
        self.register_uris(
            [
                dict(
                    ...
                    json={"nodes": [self.fake_baremetal_node, fake_baremetal_two]},
                ),
            ]
        )
        ...
        self.register_uris(
            [
                dict(
                    ...
                    json={"ports": [{"address": mac_address, "node_uuid": node_uuid}]},
                ),
                dict(
                    method="GET",
                    uri=self.get_mock_url(
        ...
        self.register_uris(
            [
                dict(
                    ...
                    uri=self.get_mock_url(
                        resource="nodes",
                        append=[self.fake_baremetal_node["uuid"], "validate"],
                    ),
    ...
    def test_node_set_provision_state_wait_timeout(self):
        ...
        return_value = self.cloud.node_set_provision_state(
            self.fake_baremetal_node["uuid"], "active", wait=True
        )
    ...
    def test_node_set_provision_state_wait_provide(self):
        ...
        return_value = self.cloud.node_set_provision_state(
            self.fake_baremetal_node["uuid"], "provide", wait=True
        )
    ...
    def test_wait_for_baremetal_node_lock_locked(self):
        ...
        self.assertIsNone(
            self.cloud.wait_for_baremetal_node_lock(self.fake_baremetal_node, timeout=1)
        )
        ...
        self.register_uris(
            [
                ...
                dict(
                    ...
                    validate=dict(json={"address": mac_address, "node_uuid": node_uuid}),
        ...
        self.register_uris(
            [
                ...
                dict(
                    ...
                    status_code=400,
                    json={"error": "no ports for you"},
                    validate=dict(json={"address": mac_address2, "node_uuid": node_uuid}),
                ),
                dict(
                    method="DELETE",
                    uri=self.get_mock_url(
...
class TestUpdateMachinePatch(base.IronicTestCase):
    ...
    def test_update_machine_patch(self):
        ...
        uris = [
            dict(
                method="GET",
                uri=self.get_mock_url(resource="nodes", append=[self.fake_baremetal_node["uuid"]]),
                json=self.fake_baremetal_node,
            ),
        ]
        if self.changed:
