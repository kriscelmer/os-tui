...
class TestSecurityGroups(base.TestCase):
    ...
    def test_delete_security_group_neutron(self):
        ...
        self.register_uris(
            [
                dict(
                    method="GET",
                    uri=self.get_mock_url("network", "public", append=["v2.0", "security-groups"]),
                    json={"security_groups": [neutron_grp_dict]},
                ),
                dict(
                    method="DELETE",
    ...
    def test_list_server_security_groups_nova(self):
        ...
        self.register_uris(
            [
                ...
                dict(
                    method="GET",
                    uri=self.get_mock_url("compute", "public", append=["servers", server["id"]]),
                    json=server,
                ),
                dict(
                    method="GET",
    ...
    def test_add_security_group_to_server_nova(self):
        ...
        self.register_uris(
            [
                ...
                dict(
                    method="POST",
                    uri="{}/servers/{}/action".format(fakes.COMPUTE_ENDPOINT, "1234"),
                    validate=dict(json={"addSecurityGroup": {"name": "nova-sec-group"}}),
                    status_code=202,
                ),
            ]
        )

        ret = self.cloud.add_server_security_groups(dict(id="1234"), "nova-sec-group")
        ...
        self.register_uris(
            [
                ...
                dict(
                    method="POST",
                    uri="{}/servers/{}/action".format(fakes.COMPUTE_ENDPOINT, "1234"),
                    validate=dict(json={"addSecurityGroup": {"name": "neutron-sec-group"}}),
                    status_code=202,
                ),
            ]
        )

        self.assertTrue(self.cloud.add_server_security_groups("server-name", "neutron-sec-group"))
        self.assert_calls()
        ...
        self.register_uris(
            [
                ...
                dict(
                    method="POST",
                    uri="{}/servers/{}/action".format(fakes.COMPUTE_ENDPOINT, "1234"),
                    validate=dict(json={"removeSecurityGroup": {"name": "nova-sec-group"}}),
                ),
            ]
        )
    ...
    def test_remove_security_group_from_server_neutron(self):
        ...
        self.assertTrue(
            self.cloud.remove_server_security_groups("server-name", "neutron-sec-group")
        )
        self.assert_calls()
    ...
    def test_add_bad_security_group_to_server_nova(self):
        ...
        ret = self.cloud.add_server_security_groups("server-name", "unknown-sec-group")
