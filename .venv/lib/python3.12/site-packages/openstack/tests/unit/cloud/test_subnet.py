...
class TestSubnet(base.TestCase):
    ...
    def test_create_subnet_from_specific_subnetpool(self):
                    ...
                    validate=dict(
                        json={
                            "subnet": {
                                ...
                                "allocation_pools": pool,
                                "dns_nameservers": dns,
                                "subnetpool_id": self.mock_subnetpool_rep["id"],
                                "prefixlen": self.prefix_length,
                                "host_routes": routes,
                            }
                        }
        ...
        mock_subnet_rep.update({"prefixlen": self.prefix_length, "use_default_subnetpool": None})
        self._compare_subnets(mock_subnet_rep, subnet)
        self.assert_calls()
        ...
        self.register_uris(
            [
                ...
                dict(
                    ...
                    json={"subnet": expected_subnet},
                    validate=dict(json={"subnet": {"gateway_ip": gateway}}),
                ),
            ]
        )
        ...
        self.register_uris(
            [
                ...
                dict(
                    ...
                    json={"subnet": expected_subnet},
                    validate=dict(json={"subnet": {"gateway_ip": None}}),
                ),
            ]
        )
