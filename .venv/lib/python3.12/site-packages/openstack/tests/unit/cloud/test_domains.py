...
class TestDomains(base.TestCase):
    ...
    def test_list_domains(self):
        ...
        self.assertThat(domains[0].name, matchers.Equals(domain_data.domain_name))
    ...
    def test_get_domain_with_name_or_id(self):
        ...
        self.register_uris(
            [
                ...
                dict(
                    method="GET",
                    uri=self.get_mock_url(qs_elements=["name=" + domain_data.domain_name]),
                    status_code=200,
                    json=response,
                ),
            ]
    ...
    def test_create_domain(self):
        domain_data = self._get_domain_data(description=uuid.uuid4().hex, enabled=True)
        self.register_uris(
            [
                dict(
                    method="POST",
        ...
        domain = self.cloud.create_domain(domain_data.domain_name, domain_data.description)
        self.assertThat(domain.id, matchers.Equals(domain_data.domain_id))
        self.assertThat(domain.name, matchers.Equals(domain_data.domain_name))
