        ...
        self.register_uris(
            [
                dict(
                    ...
                    uri=self._make_mock_url("firewall_rules", self.firewall_rule_name),
                    status_code=404,
                ),
                dict(
                    method="GET",
                    uri=self._make_mock_url("firewall_rules", name=self.firewall_rule_name),
                    json={"firewall_rules": [self.mock_firewall_rule]},
                ),
                dict(
                    method="DELETE",
                    uri=self._make_mock_url("firewall_rules", self.firewall_rule_id),
                    json={},
                    status_code=204,
                ),
            ]
    ...
    def test_delete_firewall_rule_filters(self):
        ...
        self.register_uris(
            [
                dict(
                    method="GET",  # short-circuit
                    uri=self._make_mock_url("firewall_rules", self.firewall_rule_name, **filters),
                    status_code=404,
                ),
                dict(
                    method="GET",
...
class TestFirewallPolicy(FirewallTestCase):
    ...
    def test_create_firewall_policy(self):
        ...
        self.register_uris(
            [
                dict(
                    method="GET",  # short-circuit
                    uri=self._make_mock_url("firewall_rules", TestFirewallRule.firewall_rule_name),
                    status_code=404,
                ),
                dict(
                    method="GET",
                    ...
                    json={"firewall_rules": [TestFirewallRule._mock_firewall_rule_attrs]},
                ),
                dict(
                    method="POST",
                    uri=self._make_mock_url("firewall_policies"),
                    json={"firewall_policy": created_attrs},
                    validate=dict(json={"firewall_policy": validate_attrs}),
                ),
            ]
        )
    ...
    def test_create_firewall_policy_rule_not_found(self):
        ...
        self.register_uris(
            [
                dict(
                    method="GET",  # short-circuit
                    uri=self._make_mock_url("firewall_rules", posted_policy["firewall_rules"][0]),
                    status_code=404,
                ),
                dict(
                    method="GET",
    ...
    def test_delete_firewall_policy(self):
        self.register_uris(
            [
                dict(
                    method="GET",  # short-circuit
                    uri=self._make_mock_url("firewall_policies", self.firewall_policy_name),
                    status_code=404,
                ),
                dict(
                    method="GET",
                    uri=self._make_mock_url("firewall_policies", name=self.firewall_policy_name),
                    json={"firewall_policies": [self.mock_firewall_policy]},
                ),
                dict(
                    method="DELETE",
                    uri=self._make_mock_url("firewall_policies", self.firewall_policy_id),
                    json={},
                    status_code=204,
                ),
            ]
    ...
    def test_list_firewall_policies_filters(self):
        ...
        self.assertListEqual(
            ...
            [FirewallPolicy(connection=self.cloud, **self.mock_firewall_policy)],
        )
        self.assert_calls()
    ...
    def test_update_firewall_policy(self):
        ...
        self.assertDictEqual(
            updated_policy,
            self.cloud.update_firewall_policy(self.firewall_policy_name, **params),
        )
        self.assert_calls()
        ...
        self.register_uris(
            [
                ...
                dict(
                    method="GET",
                    uri=self._make_mock_url("firewall_policies", name=self.firewall_policy_name),
                    json={"firewall_policies": [deepcopy(self.mock_firewall_policy)]},
                ),
                dict(
                    method="PUT",
                    uri=self._make_mock_url("firewall_policies", self.firewall_policy_id),
    ...
    def test_update_firewall_policy_filters(self):
        ...
        with mock.patch.object(
            ...
            self.assertDictEqual(
                updated_policy,
                self.cloud.update_firewall_policy(self.firewall_policy_name, filters, **params),
            )
            self.assert_calls()
            self.cloud.network.find_firewall_policy.assert_called_once_with(
                self.firewall_policy_name, ignore_missing=False, **filters
    ...
    def test_insert_rule_into_policy_not_found(self):
        ...
        self.register_uris(
            [
                ...
                dict(
                    method="GET",
                    uri=self._make_mock_url("firewall_policies", name=policy_name),
                    json={"firewall_policies": []},
                ),
            ]
        )
...
class TestFirewallGroup(FirewallTestCase):
    ...
    def setUp(self, cloud_config_fixture="clouds.yaml"):
        ...
        self.mock_ingress_policy = FirewallPolicy(
            connection=self.cloud, **self._mock_ingress_policy_attrs
        ).to_dict()
        self.mock_firewall_group = FirewallGroup(
            connection=self.cloud, **self._mock_firewall_group_attrs
        ).to_dict()
        self.mock_returned_firewall_group = FirewallGroup(
            connection=self.cloud, **self._mock_returned_firewall_group_attrs
        ).to_dict()
    ...
    def test_create_firewall_group(self):
        ...
        self.register_uris(
            [
                dict(
                    method="GET",  # short-circuit
                    uri=self._make_mock_url("firewall_policies", self.mock_egress_policy["name"]),
                    status_code=404,
                ),
                dict(
                    method="GET",
                ...
                dict(
                    method="GET",  # short-circuit
                    uri=self._make_mock_url("firewall_policies", self.mock_ingress_policy["name"]),
                    status_code=404,
                ),
                dict(
                    method="GET",
                ...
                dict(
                    ...
                    json={"firewall_group": deepcopy(self.mock_returned_firewall_group)},
    ...
    def test_delete_firewall_group(self):
        self.register_uris(
            [
                dict(
                    method="GET",  # short-circuit
                    uri=self._make_mock_url("firewall_groups", self.firewall_group_name),
                    status_code=404,
                ),
                dict(
                    method="GET",
                    uri=self._make_mock_url("firewall_groups", name=self.firewall_group_name),
                    json={"firewall_groups": [deepcopy(self.mock_returned_firewall_group)]},
                ),
                dict(
                    method="DELETE",
                    uri=self._make_mock_url("firewall_groups", self.firewall_group_id),
                    status_code=204,
                ),
            ]
        )
    ...
    def test_update_firewall_group(self):
        ...
        self.register_uris(
            [
                ...
                dict(
                    ...
                    json={"firewall_policies": [deepcopy(self.mock_egress_policy)]},
                ),
                dict(
                    method="GET",  # short-circuit
                    uri=self._make_mock_url("firewall_policies", self.mock_ingress_policy["name"]),
                ...
                dict(
                    ...
                    json={"firewall_policies": [deepcopy(self.mock_ingress_policy)]},
                ),
                dict(
                    method="GET",
                    uri=self.get_mock_url(
                    ...
                    validate=dict(
                        json={
                            "firewall_group": {
                                ...
                                "egress_firewall_policy_id": self.mock_egress_policy[  # noqa: E501
                                    "id"
                                ],
                                "ingress_firewall_policy_id": self.mock_ingress_policy[  # noqa: E501
                                    "id"
                                ],
        ...
        self.assertDictEqual(
            updated_group,
            self.cloud.update_firewall_group(self.firewall_group_name, **params),
        )
        self.assert_calls()
