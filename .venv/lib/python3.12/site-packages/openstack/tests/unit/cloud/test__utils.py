...
class TestUtils(base.TestCase):
    ...
    def test__filter_list_unicode(self):
        ...
        data = [el1, el2, el3]
        ret = _utils._filter_list(data, "中文", {"other": {"financial": {"status": "rich"}}})
        self.assertEqual([el2], ret)
    ...
    def test_safe_dict_min_not_int(self):
        ...
        with testtools.ExpectedException(
            ...
            "Search for minimum value failed. Value for f1 is not an integer: aaa",
        ):
    ...
    def test_safe_dict_max_not_int(self):
        ...
        with testtools.ExpectedException(
            exceptions.SDKException,
            "Search for maximum value failed. Value for f1 is not an integer: aaa",
        ):
