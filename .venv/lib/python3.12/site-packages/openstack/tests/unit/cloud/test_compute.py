    ...
    def test_get_server(self):
        ...
        self.register_uris(
            [
                ...
                dict(
                    method="GET",
                    uri=self.get_mock_url("compute", "public", append=["servers", "mickey"]),
                    status_code=404,
                ),
                dict(
                    method="GET",
    ...
    def test_get_server_not_found(self):
        self.register_uris(
            [
                ...
                dict(
                    method="GET",
                    uri=self.get_mock_url("compute", "public", append=["servers", "doesNotExist"]),
                    status_code=404,
                ),
                dict(
                    method="GET",
    ...
    def test_list_servers(self):
        ...
        self.register_uris(
            [
                ...
                dict(
                    method="GET",
                    uri=self.get_mock_url("compute", "public", append=["servers", "detail"]),
    ...
    def test_list_server_private_ip(self):
            ...
            "subnets": [
                {
                    ...
                    "ipv6_ra_mode": None,
                    "allocation_pools": [{"start": "10.24.4.2", "end": "10.24.4.254"}],
                    "host_routes": [],
                    "revision_number": 0,
                    "ip_version": 4,
        ...
        self.register_uris(
            [
                ...
                dict(
                    method="GET",
                    uri=self.get_mock_url("compute", "public", append=["servers", server_id]),
