...
class TestUsage(base.TestCase):
    ...
    def test_make_it(self):
        ...
        self.assertEqual(EXAMPLE["server_usages"][0]["instance_id"], ssot.instance_id)
        self.assertEqual(EXAMPLE["server_usages"][0]["name"], ssot.name)
        self.assertEqual(EXAMPLE["server_usages"][0]["tenant_id"], ssot.project_id)
        self.assertEqual(EXAMPLE["server_usages"][0]["memory_mb"], ssot.memory_mb)
        self.assertEqual(EXAMPLE["server_usages"][0]["local_gb"], ssot.local_gb)
        self.assertEqual(EXAMPLE["server_usages"][0]["vcpus"], ssot.vcpus)
        self.assertEqual(EXAMPLE["server_usages"][0]["started_at"], ssot.started_at)
        self.assertEqual(EXAMPLE["server_usages"][0]["ended_at"], ssot.ended_at)
