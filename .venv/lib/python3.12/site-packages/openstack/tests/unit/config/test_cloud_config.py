...
class TestCloudRegion(base.TestCase):
    ...
    def test_ipv6(self):
        cc = cloud_region.CloudRegion("test1", "region-al", fake_config_dict, force_ipv4=True)
    ...
    def test_rackspace_workaround(self):
        ...
        self.assertEqual("https://example.com/v2/123456", cc.get_endpoint("block-storage"))
    ...
    def test_get_endpoint_from_catalog(self):
        ...
        self.assertEqual(
            ...
            self.cloud.config.get_endpoint_from_catalog("compute", interface="internal"),
        )
        self.assertIsNone(
            self.cloud.config.get_endpoint_from_catalog("compute", region_name="unknown-region")
        )
        self.assertEqual(
