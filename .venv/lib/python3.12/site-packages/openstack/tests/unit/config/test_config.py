...
class TestConfig(base.TestCase):
    ...
    def test_get_region_no_region(self):
        ...
        region = c._get_region(cloud="_test-cloud_no_region", region_name="override-region")
    ...
    def test_get_region_many_regions(self):
        ...
        region = c._get_region(cloud="_test_cloud_regions", region_name="region2")
        self.assertEqual(
            region,
...
class TestMagicFixes(base.TestCase):
    ...
    def test_backwards_network_fail(self):
        ...
        self.assertRaises(exceptions.ConfigException, self._test_magic_fixes, cloud, {})
