...
class TestClusterProxy(test_proxy_base.TestProxyBase):
    ...
    def test_profile_validate(self):
        self.verify_create(self.proxy.validate_profile, profile.ProfileValidate)
    ...
    def test_receiver_delete(self):
        self.verify_delete(self.proxy.delete_receiver, receiver.Receiver, False)
    ...
    def test_wait_for_delete_params(self, mock_wait):
        ...
        mock_wait.assert_called_once_with(self.proxy, mock_resource, 1, 2, None)
