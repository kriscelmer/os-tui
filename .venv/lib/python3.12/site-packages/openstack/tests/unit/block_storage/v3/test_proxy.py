...
class TestResourceFilter(TestVolumeProxy):
    def test_resource_filters(self):
        self.verify_list(self.proxy.resource_filters, resource_filter.ResourceFilter)
...
class TestGroupType(TestVolumeProxy):
    ...
    def test_group_type_delete(self):
        self.verify_delete(self.proxy.delete_group_type, group_type.GroupType, False)

    def test_group_type_delete_ignore(self):
        self.verify_delete(self.proxy.delete_group_type, group_type.GroupType, True)
...
class TestSnapshot(TestVolumeProxy):
    ...
    def test_snapshot_delete(self):
        self.verify_delete(self.proxy.delete_snapshot, snapshot.Snapshot, False)
    ...
    def test_delete_snapshot_metadata(self):
        self._verify(
            "openstack.block_storage.v3.snapshot.Snapshot.delete_metadata_item",
...
class TestType(TestVolumeProxy):
    ...
    def test_type_encryption_update(self):
        ...
        self.verify_update(self.proxy.update_type_encryption, type.TypeEncryption)
    ...
    def test_type_encryption_delete(self):
        ...
        self.verify_delete(self.proxy.delete_type_encryption, type.TypeEncryption, False)

    def test_type_encryption_delete_ignore(self):
        self.verify_delete(self.proxy.delete_type_encryption, type.TypeEncryption, True)
...
class TestTransfer(TestVolumeProxy):
    ...
    def test_transfer_delete(self):
        self.verify_delete(self.proxy.delete_transfer, transfer.Transfer, False)
