...
class TestNetworkAddressGroup(TestNetworkProxy):
    def test_address_group_create_attrs(self):
        self.verify_create(self.proxy.create_address_group, address_group.AddressGroup)

    def test_address_group_delete(self):
        self.verify_delete(self.proxy.delete_address_group, address_group.AddressGroup, False)

    def test_address_group_delete_ignore(self):
        self.verify_delete(self.proxy.delete_address_group, address_group.AddressGroup, True)

    def test_address_group_find(self):
        self.verify_find(self.proxy.find_address_group, address_group.AddressGroup)

    def test_address_group_get(self):
        self.verify_get(self.proxy.get_address_group, address_group.AddressGroup)
    ...
    @mock.patch("openstack.network.v2._proxy.Proxy.add_addresses_to_address_group")
    def test_add_addresses_to_address_group(self, add_addresses):
        data = mock.sentinel

        self.proxy.add_addresses_to_address_group(address_group.AddressGroup, data)
    ...
    def test_remove_addresses_from_address_group(self, remove_addresses):
        ...
        self.proxy.remove_addresses_from_address_group(address_group.AddressGroup, data)

        remove_addresses.assert_called_once_with(address_group.AddressGroup, data)


class TestNetworkAddressScope(TestNetworkProxy):
    def test_address_scope_create_attrs(self):
        self.verify_create(self.proxy.create_address_scope, address_scope.AddressScope)

    def test_address_scope_delete(self):
        self.verify_delete(self.proxy.delete_address_scope, address_scope.AddressScope, False)

    def test_address_scope_delete_ignore(self):
        self.verify_delete(self.proxy.delete_address_scope, address_scope.AddressScope, True)

    def test_address_scope_find(self):
        self.verify_find(self.proxy.find_address_scope, address_scope.AddressScope)

    def test_address_scope_get(self):
        self.verify_get(self.proxy.get_address_scope, address_scope.AddressScope)
    ...
    def test_address_scope_update(self):
        self.verify_update(self.proxy.update_address_scope, address_scope.AddressScope)
...
class TestNetworkAvailability(TestNetworkProxy):
    def test_availability_zones(self):
        self.verify_list(self.proxy.availability_zones, availability_zone.AvailabilityZone)
...
class TestNetworkHealthMonitor(TestNetworkProxy):
    def test_health_monitor_create_attrs(self):
        self.verify_create(self.proxy.create_health_monitor, health_monitor.HealthMonitor)
    ...
    def test_health_monitor_update(self):
        self.verify_update(self.proxy.update_health_monitor, health_monitor.HealthMonitor)
...
class TestNetworkListener(TestNetworkProxy):
    ...
    def test_listener_delete(self):
        self.verify_delete(self.proxy.delete_listener, listener.Listener, False)
...
class TestNetworkLoadBalancer(TestNetworkProxy):
    def test_load_balancer_create_attrs(self):
        self.verify_create(self.proxy.create_load_balancer, load_balancer.LoadBalancer)

    def test_load_balancer_delete(self):
        self.verify_delete(self.proxy.delete_load_balancer, load_balancer.LoadBalancer, False)

    def test_load_balancer_delete_ignore(self):
        self.verify_delete(self.proxy.delete_load_balancer, load_balancer.LoadBalancer, True)
...
class TestNetworkMeteringLabel(TestNetworkProxy):
    def test_metering_label_create_attrs(self):
        self.verify_create(self.proxy.create_metering_label, metering_label.MeteringLabel)
    ...
    def test_metering_label_find(self):
        self.verify_find(self.proxy.find_metering_label, metering_label.MeteringLabel)

    def test_metering_label_get(self):
        self.verify_get(self.proxy.get_metering_label, metering_label.MeteringLabel)

    def test_metering_labels(self):
        self.verify_list(self.proxy.metering_labels, metering_label.MeteringLabel)

    def test_metering_label_update(self):
        self.verify_update(self.proxy.update_metering_label, metering_label.MeteringLabel)
...
class TestNetworkServiceProfile(TestNetworkProxy):
    def test_service_profile_create_attrs(self):
        self.verify_create(self.proxy.create_service_profile, service_profile.ServiceProfile)
    ...
    def test_service_profile_find(self):
        self.verify_find(self.proxy.find_service_profile, service_profile.ServiceProfile)

    def test_service_profile_get(self):
        self.verify_get(self.proxy.get_service_profile, service_profile.ServiceProfile)

    def test_service_profiles(self):
        self.verify_list(self.proxy.service_profiles, service_profile.ServiceProfile)

    def test_service_profile_update(self):
        self.verify_update(self.proxy.update_service_profile, service_profile.ServiceProfile)
...
class TestNetworkQosRuleType(TestNetworkProxy):
    def test_qos_rule_type_find(self):
        self.verify_find(self.proxy.find_qos_rule_type, qos_rule_type.QoSRuleType)

    def test_qos_rule_type_get(self):
        self.verify_get(self.proxy.get_qos_rule_type, qos_rule_type.QoSRuleType)
...
class TestNetworkRbacPolicy(TestNetworkProxy):
    def test_rbac_policy_create_attrs(self):
        self.verify_create(self.proxy.create_rbac_policy, rbac_policy.RBACPolicy)

    def test_rbac_policy_delete(self):
        self.verify_delete(self.proxy.delete_rbac_policy, rbac_policy.RBACPolicy, False)

    def test_rbac_policy_delete_ignore(self):
        self.verify_delete(self.proxy.delete_rbac_policy, rbac_policy.RBACPolicy, True)
    ...
    def test_rbac_policy_update(self):
        self.verify_update(self.proxy.update_rbac_policy, rbac_policy.RBACPolicy)
...
class TestNetworkFirewallGroup(TestNetworkProxy):
    ...
    def test_firewall_groups(self):
        self.verify_list(self.proxy.firewall_groups, firewall_group.FirewallGroup)
...
class TestNetworkPolicy(TestNetworkProxy):
    def test_firewall_policy_create_attrs(self):
        self.verify_create(self.proxy.create_firewall_policy, firewall_policy.FirewallPolicy)
    ...
    def test_firewall_policy_find(self):
        self.verify_find(self.proxy.find_firewall_policy, firewall_policy.FirewallPolicy)

    def test_firewall_policy_get(self):
        self.verify_get(self.proxy.get_firewall_policy, firewall_policy.FirewallPolicy)

    def test_firewall_policies(self):
        self.verify_list(self.proxy.firewall_policies, firewall_policy.FirewallPolicy)

    def test_firewall_policy_update(self):
        self.verify_update(self.proxy.update_firewall_policy, firewall_policy.FirewallPolicy)


class TestNetworkRule(TestNetworkProxy):
    def test_firewall_rule_create_attrs(self):
        self.verify_create(self.proxy.create_firewall_rule, firewall_rule.FirewallRule)

    def test_firewall_rule_delete(self):
        self.verify_delete(self.proxy.delete_firewall_rule, firewall_rule.FirewallRule, False)

    def test_firewall_rule_delete_ignore(self):
        self.verify_delete(self.proxy.delete_firewall_rule, firewall_rule.FirewallRule, True)

    def test_firewall_rule_find(self):
        self.verify_find(self.proxy.find_firewall_rule, firewall_rule.FirewallRule)

    def test_firewall_rule_get(self):
        self.verify_get(self.proxy.get_firewall_rule, firewall_rule.FirewallRule)

    def test_firewall_rules(self):
        self.verify_list(self.proxy.firewall_rules, firewall_rule.FirewallRule)

    def test_firewall_rule_update(self):
        self.verify_update(self.proxy.update_firewall_rule, firewall_rule.FirewallRule)
...
class TestNetworkSecurityGroup(TestNetworkProxy):
    def test_security_group_create_attrs(self):
        self.verify_create(self.proxy.create_security_group, security_group.SecurityGroup)
    ...
    def test_security_group_find(self):
        self.verify_find(self.proxy.find_security_group, security_group.SecurityGroup)

    def test_security_group_get(self):
        self.verify_get(self.proxy.get_security_group, security_group.SecurityGroup)

    def test_security_groups(self):
        self.verify_list(self.proxy.security_groups, security_group.SecurityGroup)
...
class TestNetworkSubnet(TestNetworkProxy):
    ...
    def test_subnet_pool_create_attrs(self):
        self.verify_create(self.proxy.create_subnet_pool, subnet_pool.SubnetPool)

    def test_subnet_pool_delete(self):
        self.verify_delete(self.proxy.delete_subnet_pool, subnet_pool.SubnetPool, False)

    def test_subnet_pool_delete_ignore(self):
        self.verify_delete(self.proxy.delete_subnet_pool, subnet_pool.SubnetPool, True)
    ...
    def test_subnet_pool_update(self):
        self.verify_update(self.proxy.update_subnet_pool, subnet_pool.SubnetPool)
...
class TestNetworkVpnEndpointGroup(TestNetworkProxy):
    ...
    def test_vpn_endpoint_groups(self):
        self.verify_list(self.proxy.vpn_endpoint_groups, vpn_endpoint_group.VpnEndpointGroup)
...
class TestNetworkVpnIkePolicy(TestNetworkProxy):
    def test_ike_policy_create_attrs(self):
        self.verify_create(self.proxy.create_vpn_ike_policy, vpn_ike_policy.VpnIkePolicy)
    ...
    def test_ike_policy_delete_ignore(self):
        self.verify_delete(self.proxy.delete_vpn_ike_policy, vpn_ike_policy.VpnIkePolicy, True)

    def test_ike_policy_find(self):
        self.verify_find(self.proxy.find_vpn_ike_policy, vpn_ike_policy.VpnIkePolicy)

    def test_ike_policy_get(self):
        self.verify_get(self.proxy.get_vpn_ike_policy, vpn_ike_policy.VpnIkePolicy)

    def test_ike_policies(self):
        self.verify_list(self.proxy.vpn_ike_policies, vpn_ike_policy.VpnIkePolicy)

    def test_ike_policy_update(self):
        self.verify_update(self.proxy.update_vpn_ike_policy, vpn_ike_policy.VpnIkePolicy)


class TestNetworkVpnIpsecPolicy(TestNetworkProxy):
    def test_ipsec_policy_create_attrs(self):
        self.verify_create(self.proxy.create_vpn_ipsec_policy, vpn_ipsec_policy.VpnIpsecPolicy)
    ...
    def test_ipsec_policy_find(self):
        self.verify_find(self.proxy.find_vpn_ipsec_policy, vpn_ipsec_policy.VpnIpsecPolicy)

    def test_ipsec_policy_get(self):
        self.verify_get(self.proxy.get_vpn_ipsec_policy, vpn_ipsec_policy.VpnIpsecPolicy)

    def test_ipsec_policies(self):
        self.verify_list(self.proxy.vpn_ipsec_policies, vpn_ipsec_policy.VpnIpsecPolicy)

    def test_ipsec_policy_update(self):
        self.verify_update(self.proxy.update_vpn_ipsec_policy, vpn_ipsec_policy.VpnIpsecPolicy)


class TestNetworkVpnService(TestNetworkProxy):
    def test_vpn_service_create_attrs(self):
        self.verify_create(self.proxy.create_vpn_service, vpn_service.VpnService)

    def test_vpn_service_delete(self):
        self.verify_delete(self.proxy.delete_vpn_service, vpn_service.VpnService, False)

    def test_vpn_service_delete_ignore(self):
        self.verify_delete(self.proxy.delete_vpn_service, vpn_service.VpnService, True)
    ...
    def test_vpn_service_update(self):
        self.verify_update(self.proxy.update_vpn_service, vpn_service.VpnService)
...
class TestNetworkNDPProxy(TestNetworkProxy):
    ...
    def test_ndp_proxy_delete_ignore(self):
        self.verify_delete(self.proxy.delete_ndp_proxy, ndp_proxy.NDPProxy, True)
...
class TestNetworkBGP(TestNetworkProxy):
    def test_bgp_speaker_create(self):
        self.verify_create(self.proxy.create_bgp_speaker, bgp_speaker.BgpSpeaker)

    def test_bgp_speaker_delete(self):
        self.verify_delete(self.proxy.delete_bgp_speaker, bgp_speaker.BgpSpeaker, False)

    def test_bgp_speaker_delete_ignore(self):
        self.verify_delete(self.proxy.delete_bgp_speaker, bgp_speaker.BgpSpeaker, True)
    ...
    def test_bgp_speaker_update(self):
        self.verify_update(self.proxy.update_bgp_speaker, bgp_speaker.BgpSpeaker)
...
class TestNetworkTapMirror(TestNetworkProxy):
    ...
    def test_delete_tap_mirror(self):
        self.verify_delete(self.proxy.delete_tap_mirror, tap_mirror.TapMirror, False)

    def test_delete_tap_mirror_ignore(self):
        self.verify_delete(self.proxy.delete_tap_mirror, tap_mirror.TapMirror, True)
...
class TestNetworkPortBinding(TestNetworkProxy):
    ...
    def test_activate_port_binding(self, activate_binding):
        ...
        activate_binding.assert_called_once_with(port_binding.PortBinding, data)
    ...
    def test_delete_port_binding(self, mock_get, delete_port_binding):
        ...
        delete_port_binding.assert_called_once_with(port_binding.PortBinding, data)
