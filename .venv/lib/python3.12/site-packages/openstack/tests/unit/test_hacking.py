...
class HackingTestCase(base.TestCase):
    ...
    def test_assert_no_setupclass(self):
        self.assertEqual(len(list(checks.assert_no_setupclass("def setUpClass(cls)"))), 1)

        self.assertEqual(len(list(checks.assert_no_setupclass("# setUpClass is evil"))), 0)

        self.assertEqual(
            len(list(checks.assert_no_setupclass("def setUpClassyDrinkingLocation(cls)"))),
            0,
        )
