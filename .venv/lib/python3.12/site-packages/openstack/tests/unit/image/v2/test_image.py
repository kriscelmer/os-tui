...
class TestImage(base.TestCase):
    ...
    def test_make_it(self):
        ...
        self.assertEqual(EXAMPLE["instance_type_rxtx_factor"], sot.instance_type_rxtx_factor)
        ...
        self.assertEqual(EXAMPLE["hw_serial_port_count"], sot.hw_serial_port_count)
        ...
        self.assertEqual(EXAMPLE["hw_qemu_guest_agent"], sot.hw_qemu_guest_agent)
    ...
    def test_image_download_output_fd(self):
        ...
        response.headers = {
            "Content-MD5": calculate_md5_checksum(response.iter_content.return_value)
        }
