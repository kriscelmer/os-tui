...
class TestImage(TestImageProxy):
    ...
    def test_image_create_checksum_match(self):
        ...
        res = self.proxy.create_image(name="fake", md5="fake_md5", sha256="fake_sha256")
    ...
    def test_image_upload(self):
        ...
        rv = self.proxy.upload_image(data="data", container_format="x", disk_format="y", name="z")
    ...
    def test_image_update(self, mock_commit_image, mock_get_image, mock_transpose):
        original_image = _image.Image(**EXAMPLE)
        ...
        result = self.proxy.update_image(original_image, **updated_image.to_dict())
