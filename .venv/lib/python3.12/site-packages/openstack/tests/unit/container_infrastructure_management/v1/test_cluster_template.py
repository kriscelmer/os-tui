...
class TestClusterTemplate(base.TestCase):
    ...
    def test_make_it(self):
        ...
        self.assertEqual(EXAMPLE["docker_storage_driver"], sot.docker_storage_driver)
        ...
        self.assertEqual(EXAMPLE["external_network_id"], sot.external_network_id)
        ...
        self.assertEqual(EXAMPLE["floating_ip_enabled"], sot.is_floating_ip_enabled)
        self.assertEqual(EXAMPLE["hidden"], sot.is_hidden)
        self.assertEqual(EXAMPLE["master_lb_enabled"], sot.is_master_lb_enabled)
