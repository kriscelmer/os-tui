...
class TestOrchestrationResource(TestOrchestrationProxy):
    ...
    def test_resources_stack_not_found(self, mock_list, mock_find):
        ...
        ex = self.assertRaises(exceptions.NotFoundException, self.proxy.resources, stack_name)
...
class TestOrchestrationSoftwareConfig(TestOrchestrationProxy):
    def test_create_software_config(self):
        self.verify_create(self.proxy.create_software_config, sc.SoftwareConfig)
...
class TestOrchestrationSoftwareDeployment(TestOrchestrationProxy):
    def test_create_software_deployment(self):
        self.verify_create(self.proxy.create_software_deployment, sd.SoftwareDeployment)

    def test_software_deployments(self):
        self.verify_list(self.proxy.software_deployments, sd.SoftwareDeployment)

    def test_get_software_deployment(self):
        self.verify_get(self.proxy.get_software_deployment, sd.SoftwareDeployment)

    def test_update_software_deployment(self):
        self.verify_update(self.proxy.update_software_deployment, sd.SoftwareDeployment)

    def test_delete_software_deployment(self):
        self.verify_delete(self.proxy.delete_software_deployment, sd.SoftwareDeployment, True)
        self.verify_delete(self.proxy.delete_software_deployment, sd.SoftwareDeployment, False)
...
class TestExtractName(TestOrchestrationProxy):
    scenarios = [
        ...
        (
            "stack_subres",
            dict(url="/stacks/name/id/resources", parts=["stack", "resources"]),
        ),
        (
            "stack_subres_id",
            dict(url="/stacks/name/id/resources/id", parts=["stack", "resource"]),
        ),
        (
            "stack_subres_id_act",
            dict(
