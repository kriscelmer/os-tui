...
class TestNode(TestBaremetalProxy):
    ...
    def test_update_node_no_retries(self, mock_commit):
        self.proxy.update_node("uuid", instance_id="new value", retry_on_conflict=False)
        mock_commit.assert_called_once_with(mock.ANY, self.proxy, retry_on_conflict=False)
        self.assertEqual("new value", mock_commit.call_args[0][0].instance_id)
...
class TestAllocation(TestBaremetalProxy):
    ...
    def test_delete_allocation_ignore(self):
        self.verify_delete(self.proxy.delete_allocation, allocation.Allocation, True)
...
class TestVolumeTarget(TestBaremetalProxy):
    ...
    def test_create_volume_target(self):
        self.verify_create(self.proxy.create_volume_target, volume_target.VolumeTarget)
    ...
    def test_delete_volume_target(self):
        self.verify_delete(self.proxy.delete_volume_target, volume_target.VolumeTarget, False)

    def test_delete_volume_target_ignore(self):
        self.verify_delete(self.proxy.delete_volume_target, volume_target.VolumeTarget, True)
...
class TestMisc(TestBaremetalProxy):
    ...
    def test__get_with_fields_none(self, mock_fetch):
        ...
        mock_fetch.assert_called_once_with(mock.ANY, self.proxy, error_message=mock.ANY)
...
class TestInspectionRules(TestBaremetalProxy):
    ...
    def test_create_inspection_rule(self):
        self.verify_create(self.proxy.create_inspection_rule, inspection_rules.InspectionRule)
    ...
    def test_update_inspection_rule(self):
        self.verify_update(self.proxy.update_inspection_rule, inspection_rules.InspectionRule)
