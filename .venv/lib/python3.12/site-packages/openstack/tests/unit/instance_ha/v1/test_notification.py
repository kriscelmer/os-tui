...
PROGRESS_DETAILS = [
    {
        ...
        "progress": 1.0,
        "message": "Skipping recovery for process nova-compute as it is already disabled",
    }
]
...
class TestNotification(base.TestCase):
    ...
    def test_create(self):
        ...
        self.assertEqual(NOTIFICATION["notification_uuid"], sot.notification_uuid)
        ...
        self.assertEqual(NOTIFICATION["source_host_uuid"], sot.source_host_uuid)
        self.assertEqual(rec_workflow_details["name"], sot.recovery_workflow_details[0].name)
        self.assertEqual(
        ...
        self.assertIsInstance(sot.recovery_workflow_details[0].progress_details, list)
