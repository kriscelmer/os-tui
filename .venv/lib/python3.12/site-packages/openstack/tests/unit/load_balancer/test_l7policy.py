...
class TestL7Policy(base.TestCase):
    ...
    def test_make_it(self):
        ...
        self.assertEqual(EXAMPLE["operating_status"], test_l7_policy.operating_status)
        self.assertEqual(EXAMPLE["position"], test_l7_policy.position)
        self.assertEqual(EXAMPLE["project_id"], test_l7_policy.project_id)
        self.assertEqual(EXAMPLE["provisioning_status"], test_l7_policy.provisioning_status)
        self.assertEqual(EXAMPLE["redirect_pool_id"], test_l7_policy.redirect_pool_id)
        self.assertEqual(EXAMPLE["redirect_prefix"], test_l7_policy.redirect_prefix)
