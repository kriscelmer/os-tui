...
class TestL7Rule(base.TestCase):
    def test_basic(self):
        ...
        self.assertEqual("/lbaas/l7policies/%(l7policy_id)s/rules", test_l7rule.base_path)
    ...
    def test_make_it(self):
        ...
        self.assertEqual(EXAMPLE["operating_status"], test_l7rule.operating_status)
        self.assertEqual(EXAMPLE["project_id"], test_l7rule.project_id)
        self.assertEqual(EXAMPLE["provisioning_status"], test_l7rule.provisioning_status)
