...
class TestAvailabilityZone(base.TestCase):
    def test_basic(self):
        ...
        self.assertEqual("availability_zone", test_availability_zone.resource_key)
        self.assertEqual("availability_zones", test_availability_zone.resources_key)
        self.assertEqual("/lbaas/availabilityzones", test_availability_zone.base_path)
    ...
    def test_make_it(self):
        ...
        self.assertEqual(EXAMPLE["description"], test_availability_zone.description)
