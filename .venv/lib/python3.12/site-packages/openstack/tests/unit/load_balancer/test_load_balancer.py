...
class TestLoadBalancer(base.TestCase):
    ...
    def test_make_it(self):
        ...
        self.assertEqual(EXAMPLE["availability_zone"], test_load_balancer.availability_zone)
        self.assertEqual(EXAMPLE["created_at"], test_load_balancer.created_at)
        self.assertEqual(EXAMPLE["description"], test_load_balancer.description)
        ...
        self.assertEqual(EXAMPLE["operating_status"], test_load_balancer.operating_status)
        ...
        self.assertEqual(EXAMPLE["vip_address"], test_load_balancer.vip_address)
        self.assertEqual(EXAMPLE["vip_network_id"], test_load_balancer.vip_network_id)
        self.assertEqual(EXAMPLE["vip_port_id"], test_load_balancer.vip_port_id)
        self.assertEqual(EXAMPLE["vip_subnet_id"], test_load_balancer.vip_subnet_id)
        self.assertEqual(EXAMPLE["vip_qos_policy_id"], test_load_balancer.vip_qos_policy_id)
        self.assertEqual(EXAMPLE["additional_vips"], test_load_balancer.additional_vips)
