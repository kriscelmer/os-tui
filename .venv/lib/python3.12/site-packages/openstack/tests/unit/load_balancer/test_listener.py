...
class TestListener(base.TestCase):
    ...
    def test_make_it(self):
        ...
        self.assertEqual(EXAMPLE["connection_limit"], test_listener.connection_limit)
        self.assertEqual(EXAMPLE["default_pool_id"], test_listener.default_pool_id)
        self.assertEqual(EXAMPLE["description"], test_listener.description)
        self.assertEqual(EXAMPLE["id"], test_listener.id)
        self.assertEqual(EXAMPLE["insert_headers"], test_listener.insert_headers)
        self.assertEqual(EXAMPLE["l7policies"], test_listener.l7_policies)
        self.assertEqual(EXAMPLE["loadbalancers"], test_listener.load_balancers)
        ...
        self.assertEqual(EXAMPLE["sni_container_refs"], test_listener.sni_container_refs)
        ...
        self.assertEqual(EXAMPLE["provisioning_status"], test_listener.provisioning_status)
        self.assertEqual(EXAMPLE["operating_status"], test_listener.operating_status)
        self.assertEqual(EXAMPLE["timeout_client_data"], test_listener.timeout_client_data)
        self.assertEqual(
            EXAMPLE["timeout_member_connect"],
            test_listener.timeout_member_connect,
        )
        self.assertEqual(EXAMPLE["timeout_member_data"], test_listener.timeout_member_data)
        self.assertEqual(EXAMPLE["timeout_tcp_inspect"], test_listener.timeout_tcp_inspect)
        ...
        self.assertEqual(EXAMPLE["alpn_protocols"], test_listener.alpn_protocols)
