...
EXAMPLE = {
    ...
    "ca_tls_container_ref": (
        "http://198.51.100.10:9311/v1/containers/a570068c-d295-4780-91d4-3046a325db52"
    ),
    "crl_container_ref": (
        "http://198.51.100.10:9311/v1/containers/a570068c-d295-4780-91d4-3046a325db53"
    ),
}
...
class TestPool(base.TestCase):
    ...
    def test_make_it(self):
        ...
        self.assertEqual(EXAMPLE["admin_state_up"], test_pool.is_admin_state_up)
        self.assertEqual(EXAMPLE["provisioning_status"], test_pool.provisioning_status)
        self.assertEqual(EXAMPLE["protocol"], test_pool.protocol)
        self.assertEqual(EXAMPLE["operating_status"], test_pool.operating_status)
        ...
        self.assertEqual(EXAMPLE["session_persistence"], test_pool.session_persistence)
        ...
        self.assertEqual(EXAMPLE["health_monitor_id"], test_pool.health_monitor_id)
        ...
        self.assertEqual(EXAMPLE["ca_tls_container_ref"], test_pool.ca_tls_container_ref)
        self.assertEqual(EXAMPLE["crl_container_ref"], test_pool.crl_container_ref)
