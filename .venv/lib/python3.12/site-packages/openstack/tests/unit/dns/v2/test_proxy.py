...
class TestDnsZoneImport(TestDnsProxy):
    def test_zone_import_delete(self):
        self.verify_delete(self.proxy.delete_zone_import, zone_import.ZoneImport, True)
...
class TestDnsServiceStatus(TestDnsProxy):
    def test_service_statuses(self):
        self.verify_list(self.proxy.service_statuses, service_status.ServiceStatus)

    def test_service_status_get(self):
        self.verify_get(self.proxy.get_service_status, service_status.ServiceStatus)
