...
class TestGroup(base.BaseBlockStorageTest):
    ...
    def tearDown(self):
        ...
        # the group type
        self.operator_cloud.block_storage.delete_group(self.group, delete_volumes=True)
    ...
    def test_group_type(self):
        # get
        group_type = self.operator_cloud.block_storage.get_group_type(self.group_type.id)
    ...
    def test_group_type_group_specs(self):
        # create
        group_type = self.operator_cloud.block_storage.create_group_type_group_specs(
            self.group_type,
            {"foo": "bar", "acme": "buzz"},
        )
        self.assertIsInstance(group_type, _group_type.GroupType)
    ...
    def test_group_snapshot(self):
        ...
        self.group_snapshot = self.operator_cloud.block_storage.create_group_snapshot(
        ...
        # delete
        self.operator_cloud.block_storage.delete_group_snapshot(self.group_snapshot)
