...
class TestAttachment(base.BaseBlockStorageTest):
    ...
    def setUp(self):
        ...
        self.operator_cloud.compute.wait_for_server(self.server, wait=self._wait_for_timeout)
    ...
    def tearDown(self):
        ...
        self.operator_cloud.compute.wait_for_delete(self.server, wait=self._wait_for_timeout)
