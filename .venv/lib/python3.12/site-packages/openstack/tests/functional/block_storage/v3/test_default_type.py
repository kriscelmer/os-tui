...
class TestDefaultType(base.BaseBlockStorageTest):
    ...
    def test_default_type(self):
        ...
        default_type = self.operator_cloud.block_storage.show_default_type(self.PROJECT_ID)
        self.assertIsInstance(default_type, _default_type.DefaultType)
        ...
        default_type = self.operator_cloud.block_storage.unset_default_type(self.PROJECT_ID)
