...
class TestTransfer(base.BaseBlockStorageTest):
    ...
    def test_transfer(self):
        if not utils.supports_microversion(self.operator_cloud.block_storage, "3.55"):
        ...
        sot = self.user_cloud.block_storage.delete_transfer(sot.id, ignore_missing=False)
