...
class TestServerAdmin(base.BaseComputeTest):
    ...
    def _delete_server(self, server):
        ...
        self.operator_cloud.compute.wait_for_delete(server, wait=self._wait_for_timeout)
    ...
    def test_server(self):
        ...
        self.operator_cloud.compute.wait_for_server(server, wait=self._wait_for_timeout)
...
class TestServer(base.BaseComputeTest):
    ...
    def test_server(self):
        ...
        self.user_cloud.compute.wait_for_server(self.server, wait=self._wait_for_timeout)
    ...
    def test_server_metadata(self):
        ...
        self.user_cloud.compute.delete_server_metadata(server, server.metadata.keys())
        server = self.user_cloud.compute.get_server_metadata(server)
        self.assertFalse(server.metadata)
    ...
    def test_server_remote_console(self):
        ...
        network, subnet = test_network.create_network(self.user_cloud, self.server_name, self.cidr)
