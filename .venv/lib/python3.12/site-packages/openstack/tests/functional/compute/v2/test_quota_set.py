...
class TestQuotaSet(base.BaseFunctionalTest):
    ...
    def test_quota_set(self):
        ...
        quota_set = self.operator_cloud.compute.update_quota_set(self.project.id, key_pairs=123)
        ...
        defaults = self.operator_cloud.compute.get_quota_set_defaults(self.project.id)
