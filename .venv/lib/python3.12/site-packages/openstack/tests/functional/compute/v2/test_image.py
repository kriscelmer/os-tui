...
class TestImage(base.BaseFunctionalTest):
    ...
    def test_image_metadata(self):
        ...
        self.operator_cloud.compute.delete_image_metadata(self.image, self.image.metadata.keys())
        ...
        self.operator_cloud.compute.delete_image_metadata(self.image, image.metadata.keys())
        image = self.operator_cloud.compute.get_image_metadata(self.image)
        self.assertFalse(image.metadata)
