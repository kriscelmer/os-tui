...
class TestServerVolumeAttachment(base.BaseComputeTest):
    def setUp(self):
        ...
        self.user_cloud.compute.wait_for_server(server, wait=self._wait_for_timeout)
        ...
        volume = self.user_cloud.block_storage.create_volume(name=self.volume_name, size=1)
    ...
    def _delete_server(self, server):
        ...
        self.user_cloud.compute.wait_for_delete(server, wait=self._wait_for_timeout)

    def _delete_volume(self, volume):
        self.user_cloud.block_storage.delete_volume(volume.id)
        self.user_cloud.block_storage.wait_for_delete(volume, wait=self._wait_for_timeout)
    ...
    def test_volume_attachment(self):
        ...
        self.assertIsInstance(volume_attachment, _volume_attachment.VolumeAttachment)
        self.user_cloud.block_storage.wait_for_status(
        ...
        self.assertIsInstance(volume_attachments[0], _volume_attachment.VolumeAttachment)
        ...
        self.user_cloud.compute.wait_for_delete(volume_attachment, wait=self._wait_for_timeout)
