...
class TestObject(base.BaseFunctionalTest):
    ...
    def setUp(self):
        ...
        self.operator_cloud.object_store.create_container(name=self.FOLDER)
        self.addCleanup(self.operator_cloud.object_store.delete_container, self.FOLDER)
    ...
    def test_list(self):
        names = [o.name for o in self.operator_cloud.object_store.objects(container=self.FOLDER)]
        self.assertIn(self.FILE, names)

    def test_download_object(self):
        result = self.operator_cloud.object_store.download_object(self.FILE, container=self.FOLDER)
        self.assertEqual(self.DATA, result)
        result = self.operator_cloud.object_store.download_object(self.sot)
        self.assertEqual(self.DATA, result)

    def test_system_metadata(self):
        # get system metadata
        obj = self.operator_cloud.object_store.get_object_metadata(self.FILE, container=self.FOLDER)
        ...
        self.operator_cloud.object_store.set_object_metadata(
            obj, content_disposition="attachment", content_encoding="gzip"
        )
        obj = self.operator_cloud.object_store.get_object_metadata(obj)
        self.assertEqual("attachment", obj.content_disposition)
        self.assertEqual("gzip", obj.content_encoding)

        # update system metadata
        self.operator_cloud.object_store.set_object_metadata(obj, content_encoding="deflate")
        obj = self.operator_cloud.object_store.get_object_metadata(obj)
        self.assertEqual("attachment", obj.content_disposition)
        self.assertEqual("deflate", obj.content_encoding)

        # set custom metadata
        self.operator_cloud.object_store.set_object_metadata(obj, k0="v0")
        obj = self.operator_cloud.object_store.get_object_metadata(obj)
        ...
        self.operator_cloud.object_store.delete_object_metadata(obj, keys=["content_disposition"])
        obj = self.operator_cloud.object_store.get_object_metadata(obj)
        self.assertIn("k0", obj.metadata)
        self.assertEqual("v0", obj.metadata["k0"])
        self.assertIsNone(obj.content_disposition)
    ...
    def test_custom_metadata(self):
        ...
        self.operator_cloud.object_store.set_object_metadata(obj)
        obj = self.operator_cloud.object_store.get_object_metadata(obj)
        self.assertFalse(obj.metadata)

        # set empty custom metadata
        self.operator_cloud.object_store.set_object_metadata(obj, k0="")
        obj = self.operator_cloud.object_store.get_object_metadata(obj)
        self.assertFalse(obj.metadata)

        # set custom metadata
        self.operator_cloud.object_store.set_object_metadata(obj, k1="v1")
        obj = self.operator_cloud.object_store.get_object_metadata(obj)
        ...
        self.operator_cloud.object_store.set_object_metadata(self.FILE, self.FOLDER, k2="v2")
        obj = self.operator_cloud.object_store.get_object_metadata(obj)
        self.assertTrue(obj.metadata)
        ...
        self.operator_cloud.object_store.set_object_metadata(obj, k1="v1.1")
        obj = self.operator_cloud.object_store.get_object_metadata(obj)
        self.assertTrue(obj.metadata)
        self.assertEqual(2, len(obj.metadata))
        self.assertIn("k1", obj.metadata)
        ...
        self.operator_cloud.object_store.delete_object_metadata(obj, keys=["k1"])
        obj = self.operator_cloud.object_store.get_object_metadata(obj)
        self.assertTrue(obj.metadata)
        self.assertEqual(1, len(obj.metadata))
        self.assertIn("k2", obj.metadata)
