...
class TestLimit(base.BaseFunctionalTest):
    def setUp(self):
        ...
        self.registered_limit = self.system_admin_cloud.identity.create_registered_limit(
        ...
        self.addCleanup(self.system_admin_cloud.identity.delete_project, self.project)
