...
class TestMetadefResourceType(base.BaseImageTest):
    ...
    def test_metadef_resource_types(self):
        ...
        self.assertIn(self.metadef_resource_type.name, {a.name for a in associations})

        # (no find_metadef_resource_type_association method)

        # list resource types
        resource_types = list(self.operator_cloud.image.metadef_resource_types())

        self.assertIn(self.metadef_resource_type.name, {t.name for t in resource_types})
