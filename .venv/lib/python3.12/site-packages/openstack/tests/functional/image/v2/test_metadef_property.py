...
class TestMetadefProperty(base.BaseImageTest):
    def setUp(self):
        ...
        namespace = "test_" + "".join(random.choice(string.ascii_lowercase) for _ in range(75))
        self.metadef_namespace = self.operator_cloud.image.create_metadef_namespace(
            namespace=namespace,
        )
        ...
        property_name = "test_" + "".join(random.choice(string.ascii_lowercase) for _ in range(75))
        self.attrs = {
            "name": property_name,
            "title": property_name,
            "type": "string",
        ...
        self.metadef_property = self.operator_cloud.image.create_metadef_property(
            self.metadef_namespace.namespace, **self.attrs
        )
        self.assertIsInstance(self.metadef_property, _metadef_property.MetadefProperty)
        ...
        self.assertEqual(self.attrs["description"], self.metadef_property.description)
    ...
    def tearDown(self):
        ...
        self.operator_cloud.image.delete_metadef_namespace(self.metadef_namespace)
    ...
    def test_metadef_property(self):
        ...
        metadef_properties = list(
            self.operator_cloud.image.metadef_properties(self.metadef_namespace)
        )
