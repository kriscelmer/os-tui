...
class TestBareMetalChassis(base.BaseBaremetalTest):
    def test_chassis_create_get_delete(self):
        ...
        self.system_admin_cloud.baremetal.delete_chassis(chassis, ignore_missing=False)
        self.assertRaises(
    ...
    def test_chassis_negative_non_existing(self):
        ...
        self.assertIsNone(self.system_admin_cloud.baremetal.delete_chassis(uuid))
...
class TestBareMetalChassisFields(base.BaseBaremetalTest):
    ...
    def test_chassis_fields(self):
        ...
        result = self.system_admin_cloud.baremetal.chassis(fields=["uuid", "extra"])
        for ch in result:
