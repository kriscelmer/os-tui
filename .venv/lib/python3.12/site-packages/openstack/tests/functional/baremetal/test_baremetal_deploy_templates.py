...
class TestBareMetalDeployTemplate(base.BaseBaremetalTest):
    ...
    def test_baremetal_deploy_create_get_delete(self):
        ...
        loaded = self.system_admin_cloud.baremetal.get_deploy_template(deploy_template.id)
    ...
    def test_baremetal_deploy_template_list(self):
        ...
        deploy_templates_with_details = self.system_admin_cloud.baremetal.deploy_templates(
            details=True
        )
        ...
        deploy_tempalte_with_fields = self.system_admin_cloud.baremetal.deploy_templates(
            fields=["uuid"]
        )
    ...
    def test_baremetal_deploy_list_update_delete(self):
        ...
        deploy_template = self.system_admin_cloud.baremetal.update_deploy_template(deploy_template)
        self.assertEqual({"answer": 42}, deploy_template.extra)

        deploy_template = self.system_admin_cloud.baremetal.get_deploy_template(deploy_template.id)
    ...
    def test_deploy_template_patch(self):
        ...
        deploy_template = self.system_admin_cloud.baremetal.patch_deploy_template(
    ...
    def test_deploy_template_negative_non_existing(self):
        ...
        self.assertIsNone(self.system_admin_cloud.baremetal.delete_deploy_template(uuid))
