...
class TestBareMetalNode(base.BaseBaremetalTest):
    ...
    def test_node_update(self):
        ...
        node = self.operator_cloud.baremetal.update_node(node, instance_id=instance_uuid)
        ...
        node = self.operator_cloud.baremetal.update_node(node, instance_id=None)
    ...
    def test_node_update_by_name(self):
        ...
        node = self.operator_cloud.baremetal.update_node("node-name", instance_id=None)
        self.assertIsNone(node.instance_id)
    ...
    def test_node_create_in_enroll_provide(self):
        ...
        self.operator_cloud.baremetal.set_node_provision_state(node, "manage", wait=True)
        self.assertEqual(node.provision_state, "manageable")

        self.operator_cloud.baremetal.set_node_provision_state(node, "provide", wait=True)
        self.assertEqual(node.provision_state, "available")
    ...
    def test_node_create_in_enroll_provide_by_name(self):
        ...
        node = self.operator_cloud.baremetal.set_node_provision_state(name, "manage", wait=True)
        self.assertEqual(node.provision_state, "manageable")

        node = self.operator_cloud.baremetal.set_node_provision_state(name, "provide", wait=True)
        self.assertEqual(node.provision_state, "available")
    ...
    def test_node_power_state(self):
        ...
        self.operator_cloud.baremetal.set_node_power_state(node, "power on", wait=True)
        node = self.operator_cloud.baremetal.get_node(node.id)
        self.assertEqual("power on", node.power_state)

        self.operator_cloud.baremetal.set_node_power_state(node, "power off", wait=True)
        node = self.operator_cloud.baremetal.get_node(node.id)
    ...
    def test_maintenance_via_update(self):
        ...
        # Initial setting without the reason
        node = self.operator_cloud.baremetal.update_node(node, is_maintenance=True)
        self.assertTrue(node.is_maintenance)
        self.assertIsNone(node.maintenance_reason)
        ...
        # Updating the reason later
        node = self.operator_cloud.baremetal.update_node(node, maintenance_reason=reason)
        self.assertTrue(node.is_maintenance)
        self.assertEqual(reason, node.maintenance_reason)
        ...
        # Unsetting maintenance
        node = self.operator_cloud.baremetal.update_node(node, is_maintenance=False)
        self.assertFalse(node.is_maintenance)
        self.assertIsNone(node.maintenance_reason)
...
class TestNodeRetired(base.BaseBaremetalTest):
    ...
    def test_retired(self):
        ...
        # Add the reason
        node = self.operator_cloud.baremetal.update_node(node, retired_reason=reason)
        self.assertTrue(node.is_retired)
        ...
        # Unset retired
        node = self.operator_cloud.baremetal.update_node(node, is_retired=False)
...
class TestBareMetalNodeFields(base.BaseBaremetalTest):
    ...
    def test_node_fields(self):
        self.create_node()
        result = self.operator_cloud.baremetal.nodes(fields=["uuid", "name", "instance_id"])
        for item in result:
...
class TestBareMetalVif(base.BaseBaremetalTest):
    ...
    def test_node_vif_attach_detach(self):
        self.operator_cloud.baremetal.attach_vif_to_node(self.node, self.vif_id)
...
class TestTraits(base.BaseBaremetalTest):
    ...
    def test_add_remove_node_trait(self):
        ...
        self.operator_cloud.baremetal.remove_node_trait(node, "CUSTOM_FAKE", ignore_missing=False)
