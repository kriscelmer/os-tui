...
class TestBareMetalInspectionRule(base.BaseBaremetalTest):
    ...
    def test_baremetal_inspection_rule_create_get_delete(self):
        ...
        conditions = [{"op": "eq", "args": ["node:memory_mb", 4096], "multiple": "all"}]
        ...
        loaded = self.system_admin_cloud.baremetal.get_inspection_rule(inspection_rule.id)
    ...
    def test_baremetal_inspection_rule_list(self):
        ...
        inspection_rules_with_details = self.system_admin_cloud.baremetal.inspection_rules(
            details=True
        )
        ...
        inspection_rule_with_fields = self.system_admin_cloud.baremetal.inspection_rules(
            fields=["uuid"]
        )
    ...
    def test_baremetal_inspection_rule_list_update_delete(self):
        ...
        inspection_rule = self.system_admin_cloud.baremetal.update_inspection_rule(inspection_rule)
        self.assertEqual("Updated inspection rule", inspection_rule.description)

        inspection_rule = self.system_admin_cloud.baremetal.get_inspection_rule(inspection_rule.id)
    ...
    def test_baremetal_inspection_rule_update(self):
        actions = [{"op": "set-attribute", "args": ["/driver", "idrac"]}]
        conditions = [{"op": "gt", "args": ["node:memory_mb", 4096], "multiple": "all"}]
        inspection_rule = self.create_inspection_rule(
    ...
    def test_inspection_rule_negative_non_existing(self):
        ...
        self.assertIsNone(self.system_admin_cloud.baremetal.delete_inspection_rule(uuid))
