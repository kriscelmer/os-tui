...
class TestBareMetalRunbook(base.BaseBaremetalTest):
    ...
    def test_baremetal_runbook_create_get_delete(self):
        ...
        self.operator_cloud.baremetal.delete_runbook(runbook, ignore_missing=False)
        self.assertRaises(
    ...
    def test_baremetal_runbook_list(self):
        ...
        runbooks_with_details = self.operator_cloud.baremetal.runbooks(details=True)
        for runbook in runbooks_with_details:
            self.assertIsNotNone(runbook.id)
            self.assertIsNotNone(runbook.name)

        runbook_with_fields = self.operator_cloud.baremetal.runbooks(fields=["uuid"])
    ...
    def test_baremetal_runbook_list_update_delete(self):
        ...
        self.operator_cloud.baremetal.delete_runbook(runbook.id, ignore_missing=False)
