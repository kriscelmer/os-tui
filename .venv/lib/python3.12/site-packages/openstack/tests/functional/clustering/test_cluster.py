...
class TestCluster(base.BaseFunctionalTest):
    ...
    def setUp(self):
        ...
        self.profile = self.operator_cloud.clustering.create_profile(**profile_attrs)
        ...
        self.cluster = self.operator_cloud.clustering.create_cluster(**cluster_spec)
    ...
    def tearDown(self):
        ...
        test_network.delete_network(self.operator_cloud, self.network, self.subnet)
    ...
    def test_delete(self):
        cluster_delete_action = self.operator_cloud.clustering.delete_cluster(self.cluster.id)

        self.operator_cloud.clustering.wait_for_delete(self.cluster, wait=self._wait_for_timeout)

        action = self.operator_cloud.clustering.get_action(cluster_delete_action.id)
