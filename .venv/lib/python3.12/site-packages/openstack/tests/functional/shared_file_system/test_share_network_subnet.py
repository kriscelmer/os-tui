...
class ShareNetworkSubnetTest(base.BaseSharedFileSystemTest):
    def setUp(self):
        ...
        snt = self.user_cloud.shared_file_system.create_share_network(name=self.SHARE_NETWORK_NAME)
    ...
    def test_list(self):
        subs = self.user_cloud.shared_file_system.share_network_subnets(self.SHARE_NETWORK_ID)
