...
class ShareTest(base.BaseSharedFileSystemTest):
    ...
    def test_resize_share_smaller_no_shrink(self):
        ...
        self.user_cloud.share.resize_share(self.SHARE_ID, smaller_size, no_shrink=True)
    ...
    def test_resize_share_with_force(self):
        ...
        # Resize to 3 GiB
        larger_size = 3
        self.operator_cloud.share.resize_share(self.SHARE_ID, larger_size, force=True)
...
class ManageUnmanageShareTest(base.BaseSharedFileSystemTest):
    def setUp(self):
        ...
        self.export_locations = self.operator_cloud.share.export_locations(self.SHARE_ID)
        export_paths = [export["path"] for export in self.export_locations]
        self.export_path = export_paths[0]

        self.share_host = self.operator_cloud.share.get_share(self.SHARE_ID)["host"]
