...
class ShareSnapshotTest(base.BaseSharedFileSystemTest):
    ...
    def tearDown(self):
        snpt = self.operator_cloud.shared_file_system.get_share_snapshot(self.SNAPSHOT_ID)
    ...
    def test_get(self):
        sot = self.operator_cloud.shared_file_system.get_share_snapshot(self.SNAPSHOT_ID)
        self.assertEqual(self.SNAPSHOT_NAME, sot.name)

    def test_list(self):
        snaps = self.operator_cloud.shared_file_system.share_snapshots(details=True)
    ...
    def test_update(self):
        ...
        get_u_snap = self.operator_cloud.shared_file_system.get_share_snapshot(u_snap.id)
