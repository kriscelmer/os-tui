...
class ShareMetadataTest(base.BaseSharedFileSystemTest):
    ...
    def test_create(self):
        meta = {"foo": "bar"}
        created_share = self.user_cloud.shared_file_system.create_share_metadata(
            self.SHARE_ID, **meta
        )
    ...
    def test_get_item(self):
        ...
        returned_share = self.user_cloud.shared_file_system.get_share_metadata_item(
            self.SHARE_ID, "foo"
        )
    ...
    def test_update(self):
        ...
        full_metadata = self.user_cloud.shared_file_system.get_share_metadata(created_share)[
            "metadata"
        ]
        self.assertEqual(full_metadata, full_meta)

        share_with_deleted_metadata = self.user_cloud.shared_file_system.update_share_metadata(
