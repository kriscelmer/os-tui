...
class BaseSharedFileSystemTest(base.BaseFunctionalTest):
    ...
    def setUp(self):
        super().setUp()
        self.require_service("shared-file-system", min_microversion=self.min_microversion)
    ...
    def create_share(self, **kwargs):
        ...
        self.addCleanup(self.user_cloud.share.delete_share, share.id, ignore_missing=True)
    ...
    def create_share_snapshot(self, share_id, **kwargs):
        share_snapshot = self.user_cloud.share.create_share_snapshot(share_id=share_id, force=True)
        self.addCleanup(
