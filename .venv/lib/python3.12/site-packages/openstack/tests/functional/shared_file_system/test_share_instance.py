...
class ShareInstanceTest(base.BaseSharedFileSystemTest):
    ...
    def test_get(self):
        sot = self.operator_cloud.share.get_share_instance(self.SHARE_INSTANCE_ID)
    ...
    def test_reset(self):
        res = self.operator_cloud.share.reset_share_instance_status(self.SHARE_INSTANCE_ID, "error")
    ...
    def test_delete(self):
        sot = self.operator_cloud.share.get_share_instance(self.SHARE_INSTANCE_ID)
        fdel = self.operator_cloud.share.delete_share_instance(self.SHARE_INSTANCE_ID)
