...
class ResourceLocksTest(base.BaseSharedFileSystemTest):
    ...
    def test_get(self):
        share_lock = self.user_cloud.shared_file_system.get_resource_lock(self.SHARE_LOCK_ID)
        access_lock = self.user_cloud.shared_file_system.get_resource_lock(self.ACCESS_LOCK_ID)
