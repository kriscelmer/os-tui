...
class TestPort(common.TestTagNeutron):
    ...
    def setUp(self):
        ...
        self.SUB_ID = sub.id
        prt = self.user_cloud.network.create_port(name=self.PORT_NAME, network_id=self.NET_ID)
    ...
    def tearDown(self):
        ...
        sot = self.user_cloud.network.delete_subnet(self.SUB_ID, ignore_missing=False)
        self.assertIsNone(sot)
        sot = self.user_cloud.network.delete_network(self.NET_ID, ignore_missing=False)
        self.assertIsNone(sot)
        super().tearDown()
    ...
    def test_update(self):
        sot = self.user_cloud.network.update_port(self.PORT_ID, name=self.UPDATE_NAME)
