...
class TestSegment(base.BaseFunctionalTest):
    ...
    def setUp(self):
        ...
        net = self.operator_cloud.network.create_network(name=self.NETWORK_NAME)
    ...
    def tearDown(self):
        sot = self.operator_cloud.network.delete_network(self.NETWORK_ID, ignore_missing=False)
    ...
    def test_update(self):
        sot = self.operator_cloud.network.update_segment(self.SEGMENT_ID, description="update")
