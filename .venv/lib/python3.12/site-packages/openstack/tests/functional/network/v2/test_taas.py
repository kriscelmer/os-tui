...
class TestTapService(base.BaseFunctionalTest):
    def setUp(self):
        ...
        port = self.user_cloud.network.create_port(network_id=self.SERVICE_NET_ID)
    ...
    def tearDown(self):
        sot = self.user_cloud.network.delete_tap_flow(self.TAP_FLOW.id, ignore_missing=False)
        self.assertIsNone(sot)
        sot = self.user_cloud.network.delete_tap_service(self.TAP_SERVICE.id, ignore_missing=False)
        self.assertIsNone(sot)
