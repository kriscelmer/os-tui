...
class TestQoSMinimumBandwidthRule(base.BaseFunctionalTest):
    ...
    def setUp(self):
        ...
        if not self.operator_cloud.network.find_extension("qos-bw-limit-direction"):
        ...
        qos_min_bw_rule = self.operator_cloud.network.create_qos_minimum_bandwidth_rule(
            self.QOS_POLICY_ID,
    ...
    def tearDown(self):
        ...
        qos_policy = self.operator_cloud.network.delete_qos_policy(self.QOS_POLICY_ID)
    ...
    def test_list(self):
        rule_ids = [
            o.id
            for o in self.operator_cloud.network.qos_minimum_bandwidth_rules(self.QOS_POLICY_ID)
        ]
