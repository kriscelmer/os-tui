...
class TestNDPProxy(base.BaseFunctionalTest):
    ...
    def tearDown(self):
        sot = self.user_cloud.network.delete_ndp_proxy(self.NP.id, ignore_missing=False)
    ...
    def test_update(self):
        ...
        sot = self.user_cloud.network.update_ndp_proxy(self.NP.id, description=description)
