...
class TestQuota(base.BaseFunctionalTest):
    ...
    def test_quota(self):
        ...
        quota = self.operator_cloud.network.update_quota(self.project.id, networks=123456789)
        ...
        defaults = self.operator_cloud.network.get_quota_default(self.project.id)
