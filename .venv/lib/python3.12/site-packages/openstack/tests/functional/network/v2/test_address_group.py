...
class TestAddressGroup(base.BaseFunctionalTest):
    ...
    def setUp(self):
        ...
        self.assertEqual(self.ADDRESS_GROUP_DESCRIPTION, address_group.description)
    ...
    def test_find(self):
        sot = self.user_cloud.network.find_address_group(self.ADDRESS_GROUP_NAME)
    ...
    def test_update(self):
        ...
        self.assertEqual(self.ADDRESS_GROUP_DESCRIPTION_UPDATED, sot.description)
