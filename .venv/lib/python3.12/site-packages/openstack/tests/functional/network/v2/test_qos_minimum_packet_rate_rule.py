...
class TestQoSMinimumPacketRateRule(base.BaseFunctionalTest):
    ...
    def setUp(self):
        ...
        qos_min_pps_rule = self.operator_cloud.network.create_qos_minimum_packet_rate_rule(
            self.QOS_POLICY_ID,
    ...
    def test_list(self):
        rule_ids = [
            o.id
            for o in self.operator_cloud.network.qos_minimum_packet_rate_rules(self.QOS_POLICY_ID)
        ]
