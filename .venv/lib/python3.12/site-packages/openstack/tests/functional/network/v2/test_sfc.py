...
class TestSFCFlowClassifier(base.BaseFunctionalTest):
    ...
    def setUp(self):
        ...
        self.PORT_PAIR_GROUP_NAME = "my_port_pair_group" + self.getUniqueString()
        ...
        self.PORT1 = self._create_port(network=self.NETWORK, port_name=self.PORT1_NAME)
        self.PORT2 = self._create_port(network=self.NETWORK, port_name=self.PORT2_NAME)
