...
class TestSecurityGroupRule(base.BaseFunctionalTest):
    ...
    def tearDown(self):
        sot = self.user_cloud.network.delete_security_group_rule(self.RULE_ID, ignore_missing=False)
        self.assertIsNone(sot)
        sot = self.user_cloud.network.delete_security_group(self.ID, ignore_missing=False)
        self.assertIsNone(sot)
        super().tearDown()
