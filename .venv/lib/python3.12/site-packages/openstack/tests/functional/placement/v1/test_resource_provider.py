...
class TestResourceProvider(base.BaseFunctionalTest):
    def setUp(self):
        ...
        resource_provider = self.operator_cloud.placement.create_resource_provider(
    ...
    def test_resource_provider(self):
        ...
        resource_provider = self.operator_cloud.placement.find_resource_provider(
        ...
        resource_provider = self.operator_cloud.placement.get_resource_provider(
        ...
        resource_provider = self.operator_cloud.placement.update_resource_provider(
            self.resource_provider,
    ...
    def test_resource_provider_aggregates(self):
        ...
        resource_provider = self.operator_cloud.placement.set_resource_provider_aggregates(
            self.resource_provider,
            *aggregates,
        )
        ...
        resource_provider = self.operator_cloud.placement.get_resource_provider_aggregates(
            self.resource_provider,
        )
        self.assertCountEqual(aggregates, resource_provider.aggregates)
