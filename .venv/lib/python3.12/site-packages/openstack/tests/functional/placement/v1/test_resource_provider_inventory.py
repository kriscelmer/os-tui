...
class TestResourceProviderInventory(base.BaseFunctionalTest):
    ...
    def test_resource_provider_inventory(self):
        ...
        resource_provider_inventories = list(
            self.operator_cloud.placement.resource_provider_inventories(self.resource_provider)
        )
        self.assertIsInstance(
        ...
        resource_provider_inventory = self.operator_cloud.placement.get_resource_provider_inventory(
            resource_provider_inventory,
        )
        self.assertIsInstance(
            resource_provider_inventory,
        ...
        result = self.operator_cloud.placement.delete_resource_provider_inventory(
            resource_provider_inventory,
            self.resource_provider,
