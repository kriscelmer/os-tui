...
class TestHost(base.BaseFunctionalTest):
    def setUp(self):
        ...
        if not hypervisors():
            self.skipTest("Skip TestHost as there are no hypervisors configured in nova")
    ...
    def test_update(self):
        ...
        get_host = self.operator_cloud.ha.get_host(updated_host.uuid, updated_host.segment_id)
