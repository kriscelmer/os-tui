...
class TestRoles(base.KeystoneBaseFunctionalTest):
    ...
    def _create_user(self, **kwargs):
        ...
        return self.operator_cloud.create_user(domain_id=domain["id"], **kwargs)
    ...
    def test_grant_revoke_role_user_project(self):
        ...
        self.assertTrue(
            self.operator_cloud.grant_role(role_name, user=user["id"], project="demo", wait=True)
        )
        assignments = self.operator_cloud.list_role_assignments(
            {
                "role": role["id"],
        ...
        self.assertTrue(
            self.operator_cloud.revoke_role(role_name, user=user["id"], project="demo", wait=True)
        )
        assignments = self.operator_cloud.list_role_assignments(
            {
                "role": role["id"],
    ...
    def test_grant_revoke_role_group_project(self):
        ...
        self.assertTrue(
            self.operator_cloud.grant_role(role_name, group=group["id"], project="demo")
        )
        assignments = self.operator_cloud.list_role_assignments(
            {
                "role": role["id"],
        ...
        self.assertEqual(1, len(assignments))
        self.assertTrue(
            self.operator_cloud.revoke_role(role_name, group=group["id"], project="demo")
        )
        assignments = self.operator_cloud.list_role_assignments(
            {
                "role": role["id"],
    ...
    def test_grant_revoke_role_user_domain(self):
        ...
        user = self._create_user(name=user_name, email=user_email, default_project="demo")
        self.assertTrue(
            self.operator_cloud.grant_role(role_name, user=user["id"], domain="default")
        )
        assignments = self.operator_cloud.list_role_assignments(
            {
                "role": role["id"],
        ...
        self.assertEqual(1, len(assignments))
        self.assertTrue(
            self.operator_cloud.revoke_role(role_name, user=user["id"], domain="default")
        )
        assignments = self.operator_cloud.list_role_assignments(
            {
                "role": role["id"],
    ...
    def test_grant_revoke_role_group_domain(self):
        ...
        self.assertTrue(
            self.operator_cloud.grant_role(role_name, group=group["id"], domain="default")
        )
        assignments = self.operator_cloud.list_role_assignments(
            {
                "role": role["id"],
        ...
        self.assertEqual(1, len(assignments))
        self.assertTrue(
            self.operator_cloud.revoke_role(role_name, group=group["id"], domain="default")
        )
        assignments = self.operator_cloud.list_role_assignments(
            {
                "role": role["id"],
