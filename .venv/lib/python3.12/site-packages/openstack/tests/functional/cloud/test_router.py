...
class TestRouter(base.BaseFunctionalTest):
    ...
    def test_create_router_project(self):
        ...
        proj_id = project["id"]
        net1_name = self.network_prefix + "_net1"
        net1 = self.operator_cloud.create_network(name=net1_name, external=True, project_id=proj_id)
    ...
    def test_add_remove_router_interface(self):
        router = self._create_and_verify_advanced_router(external_cidr="10.3.3.0/24")
    ...
    def test_list_router_interfaces(self):
        router = self._create_and_verify_advanced_router(external_cidr="10.5.5.0/24")
        net_name = self.network_prefix + "_intnet1"
        sub_name = self.subnet_prefix + "_intsub1"
        net = self.operator_cloud.create_network(name=net_name)
        sub = self.operator_cloud.create_subnet(
    ...
    def test_update_router_name(self):
        router = self._create_and_verify_advanced_router(external_cidr="10.7.7.0/24")
    ...
    def test_update_router_admin_state(self):
        router = self._create_and_verify_advanced_router(external_cidr="10.8.8.0/24")
    ...
    def test_update_router_ext_gw_info(self):
        router = self._create_and_verify_advanced_router(external_cidr="10.9.9.0/24")
        ...
        updated = self.operator_cloud.update_router(
            ...
            ext_fixed_ips=[{"subnet_id": sub["id"], "ip_address": "10.10.10.77"}],
        )
        self.assertIsNotNone(updated)
