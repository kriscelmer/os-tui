...
class TestFlavor(base.BaseFunctionalTest):
    ...
    def test_list_flavors(self):
        ...
        public_kwargs = dict(name=pub_flavor_name, ram=1024, vcpus=2, disk=10, is_public=True)
        private_kwargs = dict(name=priv_flavor_name, ram=1024, vcpus=2, disk=10, is_public=False)
    ...
    def test_flavor_access(self):
        ...
        self.operator_cloud.remove_flavor_access(new_flavor["id"], project["id"])
        flavors = self.user_cloud.search_flavors(priv_flavor_name)
        self.assertEqual(0, len(flavors))
