...
class TestClusterTemplate(base.BaseFunctionalTest):
    def setUp(self):
        super().setUp()
        if not self.user_cloud.has_service("container-infrastructure-management"):
    ...
    def test_cluster_templates(self):
        ...
        cluster_template_get = self.user_cloud.get_cluster_template(self.ct["uuid"])
        ...
        cluster_template_delete = self.user_cloud.delete_cluster_template(self.ct["uuid"])
