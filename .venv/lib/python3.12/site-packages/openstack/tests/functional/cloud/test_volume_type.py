...
class TestVolumeType(base.BaseFunctionalTest):
    ...
    def setUp(self):
        ...
        self.operator_cloud.block_storage.post("/types", json={"volume_type": volume_type})
    ...
    def test_list_volume_types(self):
        ...
        self.assertTrue(any(x for x in volume_types if x.name == "test-volume-type"))
    ...
    def test_add_volume_type_access_bad_project(self):
        with testtools.ExpectedException(exceptions.BadRequestException, "Unable to authorize.*"):
            self.operator_cloud.add_volume_type_access("test-volume-type", "BAD_PROJECT_ID")
