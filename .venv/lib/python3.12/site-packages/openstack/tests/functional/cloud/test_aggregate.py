...
class TestAggregate(base.BaseFunctionalTest):
    def test_aggregates(self):
        ...
        aggregate_ids = [v["id"] for v in self.operator_cloud.list_aggregates()]
        ...
        aggregate = self.operator_cloud.set_aggregate_metadata(aggregate_name, {"key": "value"})
        self.assertIn("key", aggregate["metadata"])

        aggregate = self.operator_cloud.set_aggregate_metadata(aggregate_name, {"key": None})
