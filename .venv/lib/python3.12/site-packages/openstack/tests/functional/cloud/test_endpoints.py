...
class TestEndpoints(base.KeystoneBaseFunctionalTest):
    ...
    def _cleanup_endpoints(self):
        ...
        for endpoint in self.operator_cloud.list_endpoints():
            if endpoint.get("region") is not None and endpoint["region"].startswith(
                self.new_item_name
            ):
                try:
    ...
    def test_update_endpoint(self):
        ...
        service = self.operator_cloud.create_service(name="service1", type="test_type")
        ...
        new_service = self.operator_cloud.create_service(name="service2", type="test_type")
