...
class TestQosDscpMarkingRule(base.BaseFunctionalTest):
    ...
    def test_qos_dscp_marking_rule_lifecycle(self):
        ...
        policy_rules = self.operator_cloud.list_qos_dscp_marking_rules(self.policy["id"])
        self.assertEqual([updated_rule], policy_rules)

        # Delete rule
        self.operator_cloud.delete_qos_dscp_marking_rule(self.policy["id"], updated_rule["id"])
