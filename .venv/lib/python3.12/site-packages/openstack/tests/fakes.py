...
FAKE_CHOCOLATE_FLAVOR = make_fake_flavor(CHOCOLATE_FLAVOR_ID, "chocolate", ram=200)
FAKE_STRAWBERRY_FLAVOR = make_fake_flavor(STRAWBERRY_FLAVOR_ID, "strawberry", ram=300)
...
def make_fake_stack_event(id, name, status="CREATE_COMPLETED", resource_name="id"):
    ...
    return {
        ...
        "links": [
            ...
            {
                "href": resource_url.format(endpoint=ORCHESTRATION_ENDPOINT, name=name, id=id),
                "rel": "resource",
            },
            {
...
def make_fake_image(
    ...
    return {
        ...
        "tags": [],
        "visibility": "private",
        "locations": [{"url": "http://127.0.0.1/images/" + image_id, "metadata": {}}],
        "min_disk": 40,
        "virtual_size": None,
        "name": image_name,
