...
class Proxy(proxy.Proxy):
    ...
    def call_driver_vendor_passthru(
        ...
        """
        return self.get_driver(driver).call_vendor_passthru(self, verb, method, body)
    ...
    def patch_node(self, node, patch, reset_interfaces=None, retry_on_conflict=True):
    ...
    def wait_for_nodes_provision_state(
        ...
        try:
            for count in utils.iterate_timeout(
                timeout,
                f"Timeout waiting for nodes {log_nodes} to reach target state '{expected_state}'",
            ):
                ...
                self.log.debug(
                    'Still waiting for nodes %(nodes)s to reach state "%(target)s"',
                    {
    ...
    def delete_port_group(self, port_group, ignore_missing=True):
        ...
        :rtype: :class:`~openstack.baremetal.v1.port_group.PortGroup`.
        """
        return self._delete(_portgroup.PortGroup, port_group, ignore_missing=ignore_missing)
    ...
    def patch_volume_connector(self, volume_connector, patch):
        ...
        :rtype:
            :class:`~openstack.baremetal.v1.volume_connector.VolumeConnector.`
        """
        return self._get_resource(_volumeconnector.VolumeConnector, volume_connector).patch(
            self, patch
        )
    ...
    def get_volume_target(self, volume_target, fields=None):
        ...
        """
        return self._get_with_fields(_volumetarget.VolumeTarget, volume_target, fields=fields)
    ...
    def patch_deploy_template(self, deploy_template, patch):
        ...
        :rtype:
            :class:`~openstack.baremetal.v1.deploy_templates.DeployTemplate`
        """
        return self._get_resource(_deploytemplates.DeployTemplate, deploy_template).patch(
            self, patch
        )
    ...
    def patch_runbook(self, runbook, patch):
        ...
        :rtype:
            :class:`~openstack.baremetal.v1.runbooks.Runbook`
        """
        return self._get_resource(_runbooks.Runbook, runbook).patch(self, patch)
    ...
    def update_inspection_rule(self, inspection_rule, **attrs):
        ...
        :rtype:
            :class:`~openstack.baremetal.v1.inspection_rules.InspectionRule`
        """
        return self._update(_inspectionrules.InspectionRule, inspection_rule, **attrs)
    ...
    def patch_inspection_rule(self, inspection_rule, patch):
        ...
        :rtype:
            :class:`~openstack.baremetal.v1.inspection_rules.InspectionRule`
        """
        return self._get_resource(_inspectionrules.InspectionRule, inspection_rule).patch(
            self, patch
        )
