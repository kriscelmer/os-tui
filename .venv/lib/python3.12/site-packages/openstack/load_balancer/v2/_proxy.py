...
class Proxy(proxy.Proxy):
    ...
    def delete_load_balancer(self, load_balancer, ignore_missing=True, cascade=False):
        ...
        return self._delete(_lb.LoadBalancer, load_balancer, ignore_missing=ignore_missing)
    ...
    def delete_health_monitor(self, healthmonitor, ignore_missing=True):
        ...
        :returns: ``None``
        """
        return self._delete(_hm.HealthMonitor, healthmonitor, ignore_missing=ignore_missing)
    ...
    def provider_flavor_capabilities(self, provider, **query):
        ...
        """
        return self._list(_provider.ProviderFlavorCapabilities, provider=provider, **query)
    ...
    def get_availability_zone_profile(self, *attrs):
        ...
        :returns: One
            :class:`~openstack.load_balancer.v2.availability_zone_profile.AvailabilityZoneProfile`
        """
        return self._get(_availability_zone_profile.AvailabilityZoneProfile, *attrs)
    ...
    def availability_zone_profiles(self, **query):
        ...
        """
        return self._list(_availability_zone_profile.AvailabilityZoneProfile, **query)

    def delete_availability_zone_profile(self, availability_zone_profile, ignore_missing=True):
    ...
    def update_availability_zone(self, availability_zone, **attrs):
        ...
        :rtype:
            :class:`~openstack.load_balancer.v2.availability_zone.AvailabilityZone`
        """
        return self._update(_availability_zone.AvailabilityZone, availability_zone, **attrs)
