...
class Proxy(proxy.Proxy):
    ...
    def find_share(self, name_or_id, ignore_missing=True, **query):
        ...
        return self._find(_share.Share, name_or_id, ignore_missing=ignore_missing, **query)
    ...
    def find_share_group(self, name_or_id, ignore_missing=True):
        ...
        :returns: One :class:`~openstack.shared_file_system.v2.
                                        ...
                                        or None
        """
        return self._find(_share_group.ShareGroup, name_or_id, ignore_missing=ignore_missing)
    ...
    def update_share_snapshot(self, snapshot_id, **attrs):
        ...
        :rtype:
            :class:`~openstack.shared_file_system.v2.share_snapshot.ShareSnapshot`
        """
        return self._update(_share_snapshot.ShareSnapshot, snapshot_id, **attrs)
    ...
    def update_share_network(self, share_network_id, **attrs):
        ...
        :rtype: :class:`~openstack.shared_file_system.v2.
            share_network.ShareNetwork`
        """
        return self._update(_share_network.ShareNetwork, share_network_id, **attrs)
    ...
    def export_locations(self, share_id):
        ...
        """
        return self._list(_share_export_locations.ShareExportLocation, share_id=share_id)
    ...
    def access_rules(self, share, **query):
        ...
        return self._list(_share_access_rule.ShareAccessRule, share_id=share.id, **query)
    ...
    def delete_access_rule(self, access_id, share_id, ignore_missing=True, *, unrestrict=False):
        ...
        :rtype: ``requests.models.Response`` HTTP response from internal
            requests client
        """
        res = self._get_resource(_share_access_rule.ShareAccessRule, access_id, share_id=share_id)
        try:
            return res.delete(
                self,
    ...
    def delete_share_metadata(self, share_id, keys, ignore_missing=True):
        ...
        if keys_failed_to_delete:
            raise exceptions.SDKException(f"Some keys failed to be deleted {keys_failed_to_delete}")
    ...
    def resource_locks(self, **query):
        ...
        if query.get("resource_type"):
            ...
            query["__conflicting_attrs"] = {"resource_type": query.get("resource_type")}
    ...
    def update_resource_lock(self, resource_lock, **attrs):
        ...
        :rtype: :class:`~openstack.shared_file_system.v2.
            resource_locks.ResourceLock`
        """
        return self._update(_resource_locks.ResourceLock, resource_lock, **attrs)
    ...
    def update_quota_class_set(self, quota_class_name, **attrs):
        ...
        return self._update(_quota_class_set.QuotaClassSet, quota_class_name, **attrs)
