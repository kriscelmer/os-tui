...
class NetworkCloudMixin(_network_common.NetworkCommonCloudMixin):
    ...
    def get_qos_policy(self, name_or_id, filters=None):
        ...
        if not filters:
            filters = {}
        return self.network.find_qos_policy(name_or_id=name_or_id, ignore_missing=True, **filters)
    ...
    def get_qos_rule_type_details(self, rule_type, filters=None):
        ...
        if not self._has_neutron_extension("qos-rule-type-details"):
            raise exc.OpenStackCloudUnavailableExtension(
                "qos-rule-type-details extension is not available on target cloud"
            )
    ...
    def get_network(self, name_or_id, filters=None):
        ...
        if not filters:
            filters = {}
        return self.network.find_network(name_or_id=name_or_id, ignore_missing=True, **filters)
    ...
    def get_router(self, name_or_id, filters=None):
        ...
        if not filters:
            filters = {}
        return self.network.find_router(name_or_id=name_or_id, ignore_missing=True, **filters)
    ...
    def get_subnet(self, name_or_id, filters=None):
        ...
        if not filters:
            filters = {}
        return self.network.find_subnet(name_or_id=name_or_id, ignore_missing=True, **filters)
    ...
    def get_port(self, name_or_id, filters=None):
        ...
        if not filters:
            filters = {}
        return self.network.find_port(name_or_id=name_or_id, ignore_missing=True, **filters)
    ...
    def create_network(
        ...
        if availability_zone_hints is not None:
            if not isinstance(availability_zone_hints, list):
                raise exceptions.SDKException("Parameter 'availability_zone_hints' must be a list")
            if not self._has_neutron_extension("network_availability_zone"):
                raise exc.OpenStackCloudUnavailableExtension(
                    "network_availability_zone extension is not available on target cloud"
                )
            network["availability_zone_hints"] = availability_zone_hints

        if provider:
            if not isinstance(provider, dict):
                raise exceptions.SDKException("Parameter 'provider' must be a dict")
        ...
        if port_security_enabled is not None:
            if not isinstance(port_security_enabled, bool):
                raise exceptions.SDKException("Parameter 'port_security_enabled' must be a bool")
            network["port_security_enabled"] = port_security_enabled

        if mtu_size:
            if not isinstance(mtu_size, int):
                raise exceptions.SDKException("Parameter 'mtu_size' must be an integer.")
            if not mtu_size >= 68:
                raise exceptions.SDKException("Parameter 'mtu_size' must be greater than 67.")
    ...
    def set_network_quotas(self, name_or_id, **kwargs):
        ...
        if not proj:
            raise exceptions.SDKException(
                f"Project {name_or_id} was requested by was not found on the cloud"
            )
    ...
    def delete_firewall_rule(self, name_or_id, filters=None):
        ...
        try:
            ...
            self.network.delete_firewall_rule(firewall_rule, ignore_missing=False)
        except exceptions.NotFoundException:
            self.log.debug("Firewall rule %s not found for deleting", name_or_id)
            return False
        return True
    ...
    def get_firewall_rule(self, name_or_id, filters=None):
        ...
        if not filters:
            filters = {}
        return self.network.find_firewall_rule(name_or_id, ignore_missing=True, **filters)
    ...
    def update_firewall_rule(self, name_or_id, filters=None, **kwargs):
        ...
        if not filters:
            filters = {}
        firewall_rule = self.network.find_firewall_rule(name_or_id, ignore_missing=False, **filters)
    ...
    def _get_firewall_rule_ids(self, name_or_id_list, filters=None):
        ...
        for name_or_id in name_or_id_list:
            ids_list.append(
                self.network.find_firewall_rule(name_or_id, ignore_missing=False, **filters)["id"]
            )
        return ids_list
    ...
    def create_firewall_policy(self, **kwargs):
        ...
        if "firewall_rules" in kwargs:
            kwargs["firewall_rules"] = self._get_firewall_rule_ids(kwargs["firewall_rules"])
    ...
    def delete_firewall_policy(self, name_or_id, filters=None):
        ...
        try:
            ...
            self.network.delete_firewall_policy(firewall_policy, ignore_missing=False)
        except exceptions.NotFoundException:
            self.log.debug("Firewall policy %s not found for deleting", name_or_id)
            return False
        return True
    ...
    def get_firewall_policy(self, name_or_id, filters=None):
        ...
        if not filters:
            filters = {}
        return self.network.find_firewall_policy(name_or_id, ignore_missing=True, **filters)
    ...
    def insert_rule_into_policy(
        ...
        firewall_rule = self.network.find_firewall_rule(rule_name_or_id, ignore_missing=False)
    ...
    def remove_rule_from_policy(self, name_or_id, rule_name_or_id, filters=None):
        """
        ...
        if not firewall_rule:
            ...
            self.log.debug("Firewall rule %s not found for removing", rule_name_or_id)
            return firewall_policy
        ...
        return self.network.remove_rule_from_policy(firewall_policy["id"], firewall_rule["id"])
    ...
    def delete_firewall_group(self, name_or_id, filters=None):
        ...
        try:
            ...
            self.network.delete_firewall_group(firewall_group, ignore_missing=False)
        except exceptions.NotFoundException:
            self.log.debug("Firewall group %s not found for deleting", name_or_id)
            return False
        return True
    ...
    def get_firewall_group(self, name_or_id, filters=None):
        ...
        if not filters:
            filters = {}
        return self.network.find_firewall_group(name_or_id, ignore_missing=True, **filters)
    ...
    def _lookup_ingress_egress_firewall_policy_ids(self, firewall_group):
        ...
        for key in ("egress_firewall_policy", "ingress_firewall_policy"):
            ...
            if firewall_group[key] is None:
                ...
                val = self.network.find_firewall_policy(firewall_group[key], ignore_missing=False)[
                    "id"
                ]
            firewall_group[key + "_id"] = val
            del firewall_group[key]

    @_utils.valid_kwargs("name", "description", "shared", "default", "project_id")
    def create_qos_policy(self, **kwargs):
        ...
        if default is not None:
            if self._has_neutron_extension("qos-default"):
                ...
                self.log.debug("'qos-default' extension is not available on target cloud")
    ...
    def update_qos_policy(self, name_or_id, **kwargs):
        ...
        curr_policy = self.network.find_qos_policy(name_or_id, ignore_missing=True)
        if not curr_policy:
            raise exceptions.SDKException(f"QoS policy {name_or_id} not found.")
    ...
    def list_qos_bandwidth_limit_rules(self, policy_name_or_id, filters=None):
        ...
        if not policy:
            raise exceptions.NotFoundException(f"QoS policy {policy_name_or_id} not Found.")

        # Translate None from search interface to empty {} for kwargs below
        if not filters:
            filters = {}

        return list(self.network.qos_bandwidth_limit_rules(qos_policy=policy, **filters))
        ...
        **kwargs,
        ...
        if kwargs.get("direction") is not None:
            if not self._has_neutron_extension("qos-bw-limit-direction"):
                ...
                self.log.debug(
                    "'qos-bw-limit-direction' extension is not available on target cloud"
                )
    ...
    def update_qos_bandwidth_limit_rule(self, policy_name_or_id, rule_id, **kwargs):
        ...
        curr_rule = self.network.get_qos_bandwidth_limit_rule(qos_rule=rule_id, qos_policy=policy)
        if not curr_rule:
            raise exceptions.SDKException(
                "QoS bandwidth_limit_rule {rule_id} not found in policy {policy_id}".format(
    ...
    def delete_qos_bandwidth_limit_rule(self, policy_name_or_id, rule_id):
        ...
        try:
            self.network.delete_qos_bandwidth_limit_rule(rule_id, policy, ignore_missing=False)
        except exceptions.NotFoundException:
            self.log.debug(
                "QoS bandwidth limit rule {rule_id} not found in policy "
                "{policy_id}. Ignoring.".format(rule_id=rule_id, policy_id=policy["id"])
            )
            return False
    ...
    def create_qos_dscp_marking_rule(
        ...
        return self.network.create_qos_dscp_marking_rule(policy, dscp_mark=dscp_mark)

    @_utils.valid_kwargs("dscp_mark")
    def update_qos_dscp_marking_rule(self, policy_name_or_id, rule_id, **kwargs):
        ...
        if not curr_rule:
            raise exceptions.SDKException(
                "QoS dscp_marking_rule {rule_id} not found in policy {policy_id}".format(
                    rule_id=rule_id, policy_id=policy["id"]
                )
            )

        return self.network.update_qos_dscp_marking_rule(curr_rule, policy, **kwargs)
    ...
    def delete_qos_dscp_marking_rule(self, policy_name_or_id, rule_id):
        ...
        try:
            self.network.delete_qos_dscp_marking_rule(rule_id, policy, ignore_missing=False)
        except exceptions.NotFoundException:
            self.log.debug(
                "QoS DSCP marking rule {rule_id} not found in policy {policy_id}. Ignoring.".format(
                    rule_id=rule_id, policy_id=policy["id"]
                )
            )
            return False
    ...
    def get_qos_minimum_bandwidth_rule(self, policy_name_or_id, rule_id):
        ...
        policy = self.network.find_qos_policy(policy_name_or_id, ignore_missing=False)
    ...
    def update_qos_minimum_bandwidth_rule(self, policy_name_or_id, rule_id, **kwargs):
        ...
        curr_rule = self.network.get_qos_minimum_bandwidth_rule(rule_id, policy)
        if not curr_rule:
            raise exceptions.SDKException(
                "QoS minimum_bandwidth_rule {rule_id} not found in policy {policy_id}".format(
                    rule_id=rule_id, policy_id=policy["id"]
                )
            )

        return self.network.update_qos_minimum_bandwidth_rule(curr_rule, policy, **kwargs)
    ...
    def delete_qos_minimum_bandwidth_rule(self, policy_name_or_id, rule_id):
        ...
        try:
            self.network.delete_qos_minimum_bandwidth_rule(rule_id, policy, ignore_missing=False)
        except exceptions.NotFoundException:
            self.log.debug(
    ...
    def list_router_interfaces(self, router, interface_type=None):
        ...
        router_gateways = (
            [port for port in ports if port["device_owner"] == "network:router_gateway"]
    ...
    def create_router(
        ...
        if availability_zone_hints is not None:
            ...
            if not self._has_neutron_extension("router_availability_zone"):
                raise exc.OpenStackCloudUnavailableExtension(
                    "router_availability_zone extension is not available on target cloud"
                )
    ...
    def update_router(
        ...
        if routes is not None:
            if self._has_neutron_extension("extraroute"):
                ...
                self.log.warning("extra routes extension is not available on target cloud")
    ...
    def create_subnet(
        ...
        **kwargs,
        ...
        if not network:
            raise exceptions.SDKException(f"Network {network_name_or_id} not found.")
        ...
        if not cidr and not uses_subnetpool:
            raise exceptions.SDKException("arg:cidr is required when a subnetpool is not used")
        ...
        if use_default_subnetpool and subnetpool_name_or_id:
            raise exceptions.SDKException(
                "arg:use_default_subnetpool and arg:subnetpool_id may not be used at the same time"
            )
        ...
        if subnetpool_name_or_id:
            ...
            if not subnetpool:
                raise exceptions.SDKException(f"Subnetpool {subnetpool_name_or_id} not found.")
    ...
    def update_port(self, name_or_id, **kwargs):
        ...
        if port is None:
            raise exceptions.SDKException(f"failed to find port '{name_or_id}'")
    ...
    def _get_port_ids(self, name_or_id_list, filters=None):
        ...
        for name_or_id in name_or_id_list:
            ...
            if not port:
                raise exceptions.NotFoundException(f"Port {name_or_id} not found")
