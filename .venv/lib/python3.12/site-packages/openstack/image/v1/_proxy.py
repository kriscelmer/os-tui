...
class Proxy(proxy.Proxy):
    ...
    def create_image(
        ...
        **kwargs,
        ...
        if (
            ...
            raise exc.InvalidRequest("Glance v1 does not support stores or image import")
        ...
        if data and filename:
            raise exc.SDKException("Passing filename and data simultaneously is not supported")
    ...
    def _upload_image(
        ...
        **image_kwargs,
        ...
        image = self._connection._get_and_munchify("image", self.post("/images", json=image_kwargs))
