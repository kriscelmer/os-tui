...
class Proxy(proxy.Proxy):
    ...
    def read_env_and_templates(
        ...
        if environment_files:
            (
                envfiles,
                env,
            ) = template_utils.process_multiple_environments_and_files(env_paths=environment_files)
    ...
    def find_stack(self, name_or_id, ignore_missing=True, resolve_outputs=True):
        """Find a single stack
    ...
    def validate_template(self, template, environment=None, template_url=None, ignore_errors=None):
    ...
    def get_template_contents(
        ...
        try:
            ...
            raise exceptions.SDKException(f"Error in processing template files: {str(e)}")
    ...
    def _get_cleanup_dependencies(self):
        return {"orchestration": {"before": ["compute", "network", "identity"]}}
