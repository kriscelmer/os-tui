...
class Stack(resource.Resource):
    ...
    def commit(
        ...
        **kwargs,
        ...
        request = self._prepare_request(prepend_key=False, requires_id=False, base_path=base_path)
    ...
    def abandon(self, session):
        url = utils.urljoin(self.base_path, self.name, self._get_id(self), "abandon")
    ...
    def export(self, session):
        ...
        """
        url = utils.urljoin(self.base_path, self.name, self._get_id(self), "export")
    ...
    def fetch(
        ...
        **params,
        ...
        response = session.get(request.url, microversion=microversion, skip_cache=skip_cache)
        kwargs = {}
        if error_message:
    ...
    def find(cls, session, name_or_id, ignore_missing=True, **params):
        ...
        try:
            match = cls.existing(id=name_or_id, connection=session._get_connection(), **params)
