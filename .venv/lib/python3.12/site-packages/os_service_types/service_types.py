...
class ServiceTypes:
    ...
    def __init__(
        ...
        if not session and only_remote:
            raise ValueError("only_remote was requested but no Session was provided.")
    ...
    def get_official_service_data(self, service_type: str) -> types.Service | None:
    ...
    def get_service_type(self, service_type: str, permissive: bool = False) -> str | None:
        ...
        if permissive and official is None:
            ...
            return service_type
        if self._warn:
            exc.warn(exc.AliasUsageWarning, given=service_type, official=official)
        return official
    ...
    def get_service_data_for_project(self, project_name: str) -> types.Service | None:
    ...
    def get_all_service_data_for_project(self, project_name: str) -> list[types.Service]:
