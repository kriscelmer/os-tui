...
class LocalDevelop(develop.develop):
    ...
    def install_wrapper_scripts(self, dist):
        ...
        if not self.exclude_scripts:
            for args in pbr._compat.easy_install.ScriptWriter.get_script_args(dist):
...
class LocalInstallScripts(install_scripts.install_scripts):
    ...
    def run(self):
        ...
        executable = getattr(bs_cmd, "executable", pbr._compat.easy_install.sys_executable)
        if "bdist_wheel" in self.distribution.have_run:
            ...
            wsgi_script_template = pbr._compat.easy_install.ENTRY_POINTS_MAP["wsgi_scripts"]
            wsgi_scripts = pbr._compat.metadata.get_entry_points(dist, "wsgi_scripts")
        ...
        for args in pbr._compat.easy_install.ScriptWriter.get_script_args(dist, executable):
            self.write_script(*args)
