...
def get_metadata(package_name):
    ...
    if metadata_lib == METADATA_LIB_STDLIB:
        ...
        try:
            data = importlib.metadata.distribution(package_name).metadata["pbr.json"]
        ...
        try:
            data = importlib_metadata.distribution(package_name).metadata["pbr.json"]
        ...
        try:
            data = pkg_resources.get_distribution(package_name).get_metadata("pbr.json")
