...
class ValkeyBackend(BytesBackend):
    ...
    def __init__(self, arguments):
        ...
        self.socket_connect_timeout = arguments.pop("socket_connect_timeout", None)
        self.socket_keepalive = arguments.pop("socket_keepalive", False)
        self.socket_keepalive_options = arguments.pop("socket_keepalive_options", None)
        ...
        self.lock_blocking_timeout = arguments.pop("lock_blocking_timeout", None)
        ...
        self.valkey_expiration_time = arguments.pop("valkey_expiration_time", 0)
        self.connection_pool = arguments.pop("connection_pool", None)

        lock_prefix = arguments.pop("lock_prefix", None)
        if lock_prefix:
            if (not isinstance(lock_prefix, str)) or (not RE_VALID_PREFIX.match(lock_prefix)):
    ...
    def _create_client(self):
        if self.connection_pool is not None:
            ...
            # and others.
            self.writer_client = valkey.StrictValkey(connection_pool=self.connection_pool)
            ...
            if self.socket_keepalive:
                ...
                if self.socket_keepalive_options is not None:
                    args["socket_keepalive_options"] = self.socket_keepalive_options
