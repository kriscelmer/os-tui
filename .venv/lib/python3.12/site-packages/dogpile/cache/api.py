...
class CacheBackend:
    ...
    def set(self, key: KeyType, value: BackendSetType) -> None:  # pragma NO COVERAGE
    ...
    def set_serialized(self, key: KeyType, value: bytes) -> None:  # pragma NO COVERAGE
    ...
    def set_multi(self, mapping: Mapping[KeyType, BackendSetType]) -> None:  # pragma NO COVERAGE
    ...
    def set_serialized_multi(self, mapping: Mapping[KeyType, bytes]) -> None:  # pragma NO COVERAGE
    ...
    def delete_multi(self, keys: Iterable[KeyType]) -> None:  # pragma NO COVERAGE
