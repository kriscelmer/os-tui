...
class LinkifyIt:
    ...
    def __init__(self, schemas=None, options=None):
        ...
        self.tlds_default = (
            "biz|com|edu|gov|net|org|pro|web|xxx|aero|asia|coop|info|museum|name|shop|рф".split(  # noqa: E501
                "|"
            )
        )
    ...
    def _compile(self):
        ...
        #
        slist = "|".join(
            [_escape_re(name) for name, val in self._compiled.items() if len(name) > 0 and val]
        )
