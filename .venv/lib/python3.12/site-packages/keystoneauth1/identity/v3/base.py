...
class Auth(BaseAuth):
    ...
    def get_auth_ref(self, session: ks_session.Session) -> access.AccessInfoV3:
        ...
        if not ident:
            raise exceptions.AuthorizationFailure("Authentication method required (e.g. password)")
        ...
        return access.AccessInfoV3(auth_token=resp.headers["X-Subject-Token"], body=resp_data)
