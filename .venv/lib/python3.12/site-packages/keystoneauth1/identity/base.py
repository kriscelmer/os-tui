...
class BaseIdentityPlugin(plugin.BaseAuthPlugin, metaclass=abc.ABCMeta):
    ...
    def __init__(self, auth_url: str | None = None, reauthenticate: bool = True):
        super().__init__()
    ...
    def get_access(self, session: ks_session.Session, **kwargs: ty.Any) -> access.AccessInfo:
    ...
    def get_all_version_data(
        ...
        version_data: dict[str, dict[str, dict[str, list[discover.VersionData]]]] = {}
