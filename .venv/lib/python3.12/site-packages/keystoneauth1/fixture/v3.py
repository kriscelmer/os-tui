...
class Token(dict[str, ty.Any]):
    ...
    def __init__(
        ...
        if project_id or project_name or project_domain_id or project_domain_name:
        ...
        if trust_id or (trust_impersonation is not None) or trustee_user_id or trustor_user_id:
    ...
    def remove_service(self, type):
        ...
        self.root["catalog"] = [f for f in self.root.setdefault("catalog", []) if f["type"] != type]
