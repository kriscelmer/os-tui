...
class _BaseAdapter:
    ...
    def __init__(
        ...
        self._rate_semaphore = _fair_semaphore.FairSemaphore(concurrency, rate_delay)
    ...
    def _request(self, url: str, method: str, **kwargs: ty.Any) -> requests.Response:
    ...
    def register_service_argparse_arguments(
        ...
        adapter_group.add_argument(
            ...
            help=(f"Service type to request from the catalog for the {service_type} service"),
        )
        ...
        adapter_group.add_argument(
            ...
            help=(f"Service name to request from the catalog for the {service_type} service"),
        )
        ...
        adapter_group.add_argument(
            ...
            help=(f"API Interface to use for the {service_type} service [public, internal, admin]"),
        )
        ...
        adapter_group.add_argument(
            ...
            help=(f"Which version of the service API to use for the {service_type} service"),
        )

        adapter_group.add_argument(
            f"--os-{service_type}-endpoint-override",
            metavar="<name>",
            default=os.environ.get(f"OS_{service_env}_ENDPOINT_OVERRIDE", None),
            help=(
...
class Adapter(_BaseAdapter):
    def request(self, url: str, method: str, **kwargs: ty.Any) -> requests.Response:
...
class LegacyJsonAdapter(_BaseAdapter):
    ...
    def request(self, url: str, method: str, **kwargs: ty.Any) -> tuple[requests.Response, object]:
    ...
    def get(self, url: str, **kwargs: ty.Any) -> tuple[requests.Response, object]:
        """Perform a GET request.
    ...
    def head(self, url: str, **kwargs: ty.Any) -> tuple[requests.Response, object]:
        """Perform a HEAD request.
    ...
    def post(self, url: str, **kwargs: ty.Any) -> tuple[requests.Response, object]:
        """Perform a POST request.
    ...
    def put(self, url: str, **kwargs: ty.Any) -> tuple[requests.Response, object]:
        """Perform a PUT request.
    ...
    def patch(self, url: str, **kwargs: ty.Any) -> tuple[requests.Response, object]:
        """Perform a PATCH request.
    ...
    def delete(self, url: str, **kwargs: ty.Any) -> tuple[requests.Response, object]:
        """Perform a DELETE request.
...
def register_adapter_argparse_arguments(
    ...
    return Adapter.register_argparse_arguments(parser=parser, service_type=service_type)
...
def register_service_adapter_argparse_arguments(
    ...
    return Adapter.register_service_argparse_arguments(parser=parser, service_type=service_type)
