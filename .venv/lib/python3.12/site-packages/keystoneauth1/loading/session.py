...
class Session(base._BaseLoader[session.Session]):
    ...
    def register_argparse_arguments(self, parser: argparse.ArgumentParser) -> None:
...
def register_conf_options(
    ...
    return Session().register_conf_options(conf, group, deprecated_opts=deprecated_opts)


def load_from_conf_options(conf: "cfg.ConfigOpts", group: str, **kwargs: ty.Any) -> session.Session:
