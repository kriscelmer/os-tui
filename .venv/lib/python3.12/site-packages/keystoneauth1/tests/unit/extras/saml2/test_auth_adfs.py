...
class AuthenticateviaADFSTests(utils.TestCase):
    ...
    def setUp(self):
        ...
        self.ADFS_SECURITY_TOKEN_RESPONSE = utils._load_xml("ADFS_RequestSecurityTokenResponse.xml")
    ...
    def test_adfs_request_user(self):
        self.adfsplugin._prepare_adfs_request()
        user = self.adfsplugin.prepared_request.xpath(self.USER_XPATH, namespaces=self.NAMESPACES)[
            0
        ]
    ...
    def test_adfs_request_to(self):
        self.adfsplugin._prepare_adfs_request()
        to = self.adfsplugin.prepared_request.xpath(self.TO_XPATH, namespaces=self.NAMESPACES)[0]
    ...
    def _send_assertion_to_service_provider(self):
        ...
        self.requests_mock.post(self.SP_ENDPOINT, headers={"set-cookie": cookie}, status_code=302)
