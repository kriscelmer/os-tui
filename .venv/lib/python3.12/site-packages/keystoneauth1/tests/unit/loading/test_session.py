...
class ConfLoadingTests(utils.TestCase):
    ...
    def setUp(self):
        ...
        loading.register_session_conf_options(self.conf_fixture.conf, self.GROUP)
    ...
    def get_session(self, **kwargs):
        return loading.load_session_from_conf_options(self.conf_fixture.conf, self.GROUP, **kwargs)
