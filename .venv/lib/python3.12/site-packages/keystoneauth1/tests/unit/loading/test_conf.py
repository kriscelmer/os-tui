...
class ConfTests(utils.TestCase):
    ...
    def test_loading_with_no_data(self):
        lo = loading.load_auth_from_conf_options(self.conf_fixture.conf, self.GROUP)
    ...
    def test_other_params(self, m):
        ...
        self.conf_fixture.config(auth_type=driver_name, group=self.GROUP, **self.TEST_VALS)
