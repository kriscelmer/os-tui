...
class OpenIDConnectClientCredentialsTests(OpenIDConnectBaseTests, utils.TestCase):
...
class OpenIDConnectPasswordTests(OpenIDConnectBaseTests, utils.TestCase):
    ...
    def test_options(self):
        options = loading.get_plugin_loader(self.plugin_name).get_options()
        self.assertTrue(
            {"username", "password", "openid-scope"}.issubset({o.name for o in options})
        )
...
class OpenIDConnectAuthCodeTests(OpenIDConnectBaseTests, utils.TestCase):
    ...
    def test_options(self):
        options = loading.get_plugin_loader(self.plugin_name).get_options()
        self.assertTrue({"redirect-uri", "code"}.issubset({o.name for o in options}))
