...
class SessionTests(utils.TestCase):
    ...
    def test_session_debug_output_logs_openstack_request_id(self):
        ...
        expected_log = f"POST call to Identity for {self.TEST_URL} used request id req-1234"
            ...
            "errors": [
                {
                    ...
                    "title": title,
                    "detail": detail,
                    "links": [{"rel": "help", "href": "https://openstack.org"}],
                }
            ]
        }
...
class SessionAuthTests(utils.TestCase):
    ...
    def test_split_loggers(self):
        ...
        resp = sess.get(
            self.TEST_URL,
            headers={
                encodeutils.safe_encode("x-bytes-header"): encodeutils.safe_encode("bytes-value")
            },
        )
        ...
        self.assertEqual(
            f"[200] Content-Type: application/json X-OpenStack-Request-ID: {request_id}",
            response_output,
        )
        self.assertEqual(
