...
_Endpoints = collections.namedtuple("ServiceVersion", "public, internal, admin")

_ServiceVersion = collections.namedtuple("ServiceVersion", "discovery, service")
...
class CommonIdentityTests(metaclass=abc.ABCMeta):
    ...
    def test_get_all_version_data_all_interfaces(self):
        for interface in ("public", "internal", "admin"):
            ...
            disc = fixture.DiscoveryList(v2=False, v3=False)
            disc.add_nova_microversion(
                href=getattr(self.TEST_VOLUME.versions["v3"].discovery, interface),
                id="v3.0",
                status="CURRENT",
                min_version="3.0",
                version="3.20",
            ...
            # one major version.
            disc.add_nova_microversion(
                href=getattr(self.TEST_VOLUME.versions["v2"].discovery, interface),
                id="v2.0",
                status="SUPPORTED",
            )
