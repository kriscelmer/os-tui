...
class V3IdentityPlugin(utils.TestCase):
    ...
    def setUp(self):
            ...
            "projects": [
                {
                    ...
                    "enabled": "True",
                    "id": "263fd9",
                    "links": {"self": "https://identity:5000/v3/projects/263fd9"},
                    "name": "Dev Group A",
                },
                {
                    "domain_id": "1789d1",
                    "enabled": "True",
                    "id": "e56ad3",
                    "links": {"self": "https://identity:5000/v3/projects/e56ad3"},
                    "name": "Dev Group B",
                },
            ],
        ...
        self.TEST_OAUTH2_MTLS_TOKEN_RESPONSE = {
            "token": {
                ...
                "catalog": self.TEST_SERVICE_CATALOG,
                "service_providers": self.TEST_SERVICE_PROVIDERS,
                "oauth2_credential": {"x5t#S256": "7UN-z4yFIm9s4jakecGoKa4rc353pDCuFUo9fsDD_1s="},
            }
        }
    ...
    def test_full_url_overrides_endpoint_filter(self):
        ...
        resp = s.get("http://testurl/", endpoint_filter={"service_type": "compute"})
        self.assertEqual(resp.status_code, 200)
    ...
    def test_oauth2_mtls_client_credential_method(self):
        ...
        self.assertEqual(
            auth_ref.project_id,
            self.TEST_OAUTH2_MTLS_TOKEN_RESPONSE.get("token", {}).get("project", {}).get("id"),
        )
        self.assertIsNone(auth_ref.domain_id)
        self.assertEqual(
            auth_ref.oauth2_credential,
            self.TEST_OAUTH2_MTLS_TOKEN_RESPONSE.get("token", {}).get("oauth2_credential"),
        )
        self.assertEqual(
