...
class V2IdentityPlugin(utils.TestCase):
    ...
    def test_authenticate_with_username_password(self):
        ...
        a = v2.Password(self.TEST_URL, username=self.TEST_USER, password=self.TEST_PASS)
    ...
    def test_doesnt_log_password(self):
        ...
        a = v2.Password(self.TEST_URL, username=self.TEST_USER, password=password)
        s = session.Session(auth=a)
    ...
    def test_password_change_auth_state(self):
        ...
        state = json.dumps({"auth_token": auth_ref.auth_token, "body": auth_ref._data})
