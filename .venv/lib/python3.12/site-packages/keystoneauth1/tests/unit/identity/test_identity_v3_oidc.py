...
class OIDCPasswordTests(BaseOIDCTests, utils.TestCase):
    ...
    def test_otp_while_generating_the_access_token(self, mock_input):
        ...
        otp = 123
        new_otp = 111
        access_token = oidc_fixtures.ACCESS_TOKEN_VIA_PASSWORD_RESP["access_token"]
...
class OIDCDeviceAuthorizationTest(BaseOIDCTests, utils.TestCase):
    def setUp(self):
        ...
        self.DEVICE_AUTH_ENDPOINT = "https://localhost:8020/oidc/authorize/device"
    ...
    def test_get_device_authorization_request(self):
        ...
        self.requests_mock.post(self.DEVICE_AUTH_ENDPOINT, json=oidc_fixtures.DEVICE_CODE_RESP)
    ...
    def test_second_call_to_get_access_token_authorization_pending(self, m_sleep):
        """Test Device Access Token Request."""
        self._store_device_authorization_response()
    ...
    def _store_device_authorization_response(self):
        self.plugin.expires_in = int(oidc_fixtures.DEVICE_CODE_RESP["expires_in"])
        ...
        self.plugin.verification_uri = oidc_fixtures.DEVICE_CODE_RESP["verification_uri"]
