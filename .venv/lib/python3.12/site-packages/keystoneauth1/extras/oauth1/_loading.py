...
class V3OAuth1(loading.BaseIdentityLoader[v3.OAuth1]):
    ...
    def get_options(self) -> list[opts.Opt]:
        ...
        options.extend(
            [
                loading.Opt("consumer-key", required=True, help="OAuth Consumer ID/Key"),
                loading.Opt(
                    "consumer-secret",
                    required=True,
                    help="OAuth Consumer Secret",
                ),
                loading.Opt("access-key", required=True, help="OAuth Access Key"),
                loading.Opt("access-secret", required=True, help="OAuth Access Secret"),
            ]
        )
