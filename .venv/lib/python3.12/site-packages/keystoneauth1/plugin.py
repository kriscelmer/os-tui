...
BaseAuthPluginT = ty.TypeVar("BaseAuthPluginT", bound="BaseAuthPlugin", covariant=True)
...
class BaseAuthPlugin:
    ...
    def get_auth_ref(self, session: "ks_session.Session") -> ty.Optional["access.AccessInfo"]:
    ...
    def get_headers(self, session: "ks_session.Session") -> dict[str, str] | None:
    ...
    def get_endpoint(self, session: "ks_session.Session", **kwargs: ty.Any) -> str | None:
        ...
        :rtype: string
        """
        endpoint_data = self.get_endpoint_data(session, discover_versions=False, **kwargs)
        if not endpoint_data:
            return None
        return endpoint_data.url

    def get_connection_params(self, session: "ks_session.Session") -> ConnectionParams:
    ...
    def get_sp_auth_url(self, session: "ks_session.Session", sp_id: str) -> str | None:
    ...
    def get_sp_url(self, session: "ks_session.Session", sp_id: str) -> str | None:
