...
class AccessInfo:
    ...
    def __init__(self, body: dict[str, ty.Any], auth_token: str | None = None):
        ...
        self._service_providers: service_providers.ServiceProviders | None = None
    ...
    def will_expire_soon(self, stale_duration: int = STALE_TOKEN_DURATION) -> bool:
...
class AccessInfoV3(AccessInfo):
    ...
    def application_credential_id(self) -> str | None:
        return self._application_credential and self._application_credential.get("id")

    @property
    def application_credential_access_rules(
        self,
    ) -> list[types.ApplicationCredentialAccessRuleV3] | None:
        return self._application_credential and self._application_credential.get("access_rules")
    ...
    def oauth2_credential_thumbprint(self) -> str | None:
        return self._oauth2_credential and self._oauth2_credential.get("x5t#S256")
