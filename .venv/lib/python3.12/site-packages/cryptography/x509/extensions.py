    ...
    def __init__(
        ...
        if policy_qualifiers is not None:
            ...
            if not all(isinstance(x, (str, UserNotice)) for x in policy_qualifiers):
                raise TypeError(
                    "policy_qualifiers must be a list of strings and/or UserNotice objects or None"
                )
...
class PrivateKeyUsagePeriod(ExtensionType):
    ...
    def __repr__(self) -> str:
        return f"<PrivateKeyUsagePeriod(not_before={self.not_before}, not_after={self.not_after})>"
...
class NamingAuthority:
    ...
    def __repr__(self) -> str:
        return f"<NamingAuthority(id={self.id}, url={self.url}, text={self.text})>"
...
class Admissions(ExtensionType):
    ...
    def __repr__(self) -> str:
        return f"<Admissions(authority={self._authority}, admissions={self._admissions})>"
