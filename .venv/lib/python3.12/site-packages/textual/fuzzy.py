...
class FuzzySearch:
    ...
    def __init__(self, case_sensitive: bool = False, *, cache_size: int = 1024 * 4) -> None:
        ...
        self.cache: LRUCache[tuple[str, str], tuple[float, Sequence[int]]] = LRUCache(cache_size)
    ...
    def _match(self, query: str, candidate: str) -> Iterable[tuple[float, Sequence[int]]]:
