...
class DOMQuery(Generic[QueryType]):
    ...
    def __init__(
        ...
        *,
        ...
        self._filters: list[tuple[SelectorSet, ...]] = parent._filters.copy() if parent else []
        self._excludes: list[tuple[SelectorSet, ...]] = parent._excludes.copy() if parent else []
        self._deep = deep
    ...
    def only_one(self, expect_type: type[ExpectType] | None = None) -> QueryType | ExpectType:
    ...
    def last(self, expect_type: type[ExpectType] | None = None) -> QueryType | ExpectType:
    ...
    def set_styles(self, css: str | None = None, **update_styles) -> DOMQuery[QueryType]:
