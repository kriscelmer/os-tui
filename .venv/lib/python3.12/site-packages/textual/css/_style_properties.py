        ...
        if isinstance(value, (int, float)):
            ...
            try:
                ...
                raise StyleValueError(
                    ...
                    help_text=scalar_help_text(property_name=self.name, context="inline"),
                )
        else:
            ...
            try:
                ...
                raise StyleValueError(
                    ...
                    help_text=spacing_wrong_number_of_values_help_text(
                        ...
                        num_values_supplied=(1 if isinstance(spacing, int) else len(spacing)),
                        context="inline",
                    ),
                )
...
class StringEnumProperty(Generic[EnumType]):
    ...
    def __get__(self, obj: StylesBase, objtype: type[StylesBase] | None = None) -> EnumType:
            ...
            for word in words:
                if not valid_word(word):
                    raise StyleValueError(
                        ...
                        help_text=style_flags_property_help_text(self.name, word, context="inline"),
                    )
            try:
