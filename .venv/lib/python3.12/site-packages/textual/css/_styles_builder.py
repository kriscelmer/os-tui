...
class StylesBuilder:
    ...
    def process_constrain(self, name: str, tokens: list[Token]) -> None:
        if len(tokens) == 1:
            ...
            constrain_x, constrain_y = self._process_enum_multiple(name, tokens, VALID_CONSTRAIN, 2)
    ...
    def process_hatch(self, name: str, tokens: list[Token]) -> None:
        ...
        if color_token.name in ("color", "token"):
            ...
            self.error(name, color_token, f"Expected a color; found {color_token.value!r}")
    ...
    def _get_suggested_property_name_for_rule(self, rule_name: str) -> str | None:
        ...
        """
        processable_rules_name = [attr[8:] for attr in dir(self) if attr.startswith("process_")]
