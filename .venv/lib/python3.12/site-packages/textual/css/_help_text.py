    ...
    return ContextSpecificBullets(
        inline=[
            Bullet(
                ...
                examples=[
                    Example(f"widget.styles.{property_name} = (1, 2) [dim]# Vertical, horizontal"),
                    Example(
        ...
        css=[
            Bullet(
                ...
                examples=[
                    ...
                    Example(f"{property_name}: 1 2 3 4; [dim]# Top, right, bottom, left"),
                ],
            ),
        ],
    )
...
def color_property_help_text(
    ...
    *,
    ...
    return HelpText(
        summary=summary,
        bullets=[
            Bullet(f"The [i]{property_name}[/] property can only be set to a valid color"),
            ...
            *ContextSpecificBullets(
                inline=[
                    Bullet(
                        ...
                        examples=[
                            Example(f'widget.styles.{property_name} = ("solid", "red")'),
                            Example(f'widget.styles.{property_name} = ("round", "#f0f0f0")'),
                            Example(
                                f'widget.styles.{property_name} = [("dashed", "#f0f0f0"), ("solid", "blue")]  [dim]# Vertical, horizontal'
                            ),
                        ],
                    ),
                    Bullet(f"Valid values for <bordertype> are:\n{friendly_list(VALID_BORDER)}"),
                    Bullet("Colors can be specified using hex, RGB, or ANSI color names"),
                ],
                css=[
                    Bullet(
...
def dock_property_help_text(property_name: str, context: StylingContext) -> HelpText:
    ...
    return HelpText(
        summary=f"Invalid value for [i]{property_name}[/] property",
        bullets=[
            Bullet("The value must be one of 'top', 'right', 'bottom', 'left' or 'none'"),
            *ContextSpecificBullets(
                inline=[
                    Bullet(
        ...
        bullets=[
            Bullet(
                ...
                examples=[
                    ...
                    Example("align: left middle;    [dim]# Align on the middle left of the parent"),
                ],
            ),
            Bullet(f"Valid values for <horizontal> are {friendly_list(VALID_ALIGN_HORIZONTAL)}"),
            Bullet(
            ...
            *ContextSpecificBullets(
                inline=[
                    Bullet(
                        ...
                        examples=[
                            Example(f'widget.styles.{property_name} = "bold italic underline"')
                        ],
                    ),
                ],
                css=[
