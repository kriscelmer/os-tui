    ...
    *
    ...
    def check(self, node: DOMNode) -> bool:
        ...
        return self._check(node) and (
            node.has_pseudo_classes(self.pseudo_classes) if self.pseudo_classes else True
        )
...
class RuleSet:
    ...
    def selectors(self):
        return ", ".join(
            self._selector_to_css(selector_set.selectors) for selector_set in self.selector_set
        )
