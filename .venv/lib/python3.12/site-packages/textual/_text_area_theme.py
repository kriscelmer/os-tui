...
class TextAreaTheme:
    ...
    def apply_css(self, text_area: TextArea) -> None:
        ...
        if self.base_style.bgcolor is None:
            self.base_style = Style(color=self.base_style.color, bgcolor=app_theme.surface)
        ...
        if not configured("selection_style"):
            ...
            if selection_style:
                ...
                selection_background_color = background_color.blend(app_theme.primary, factor=0.5)
