...
class RichVisual(Visual):
    ...
    def get_optimal_width(self, rules: RulesMap, container_width: int) -> int:
        ...
        width = measure(console, self._renderable, container_width, container_width=container_width)
        return width
    ...
    def render_strips(
        ...
        strips = [
            Strip(line)
            for line in islice(
                Segment.split_and_crop_lines(segments, width, include_new_lines=False, pad=False),
                None,
                height,
            )
        ]
...
class Padding(Visual):
    ...
    def get_optimal_width(self, rules: RulesMap, container_width: int) -> int:
        return self._visual.get_optimal_width(rules, container_width) + self._spacing.width

    def get_height(self, rules: RulesMap, width: int) -> int:
        return self._visual.get_height(rules, width - self._spacing.width) + self._spacing.height
    ...
    def render_strips(
        ...
        if padding:
            ...
            strips = [
                *top_padding,
                *[strip.crop_pad(render_width, left, right, rich_style) for strip in strips],
                *bottom_padding,
            ]
