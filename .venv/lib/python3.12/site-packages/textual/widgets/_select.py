...
class SelectOverlay(OptionList):
    ...
    def on_mount(self) -> None:
        ...
        self._search_reset_timer = Timer(self, self._search_reset_delay, callback=reset_query)
    ...
    def check_consume_key(self, key: str, character: str | None = None) -> bool:
        ...
        return self._type_to_search and character is not None and character.isprintable()
    ...
    def _find_search_match(self, query: str) -> int | None:
        ...
        for index, option in enumerate(self._options):
            ...
            if match_index != -1 and (minimum_index is None or match_index < minimum_index):
                best_match = index
...
class Select(Generic[SelectType], Vertical, can_focus=True):
    ...
    value: var[SelectType | NoSelection] = var[Union[SelectType, NoSelection]](BLANK, init=False)
    ...
    def _setup_options_renderables(self) -> None:
        ...
        options: list[Option] = [
            (Option(Text(self.prompt, style="dim")) if value == self.BLANK else Option(prompt))
    ...
    def _validate_value(self, value: SelectType | NoSelection) -> SelectType | NoSelection:
        ...
        if value not in self._legal_values:
            ...
            raise InvalidSelectValueError(f"Illegal select value {value!r}." + help_text)
