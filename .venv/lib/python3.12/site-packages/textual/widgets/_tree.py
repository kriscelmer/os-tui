        ...
        if after is not None:
            if isinstance(after, int):
                ...
                try:
                    ...
                    raise AddNodeError("The node specified for `after` is not a child of this node")
            else:
                raise TypeError(
...
class Tree(Generic[TreeDataType], ScrollView, can_focus=True):
    ...
    def move_cursor(self, node: TreeNode[TreeDataType] | None, animate: bool = False) -> None:
    ...
    def scroll_to_node(self, node: TreeNode[TreeDataType], animate: bool = True) -> None:
    ...
    def _build(self) -> None:
        ...
        def get_line_width(line: _TreeLine[TreeDataType]) -> int:
            return get_label_width(line.node) + line._get_guide_width(guide_depth, show_root)
