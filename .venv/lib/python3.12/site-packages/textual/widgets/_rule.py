...
class Rule(Widget, can_focus=False):
    ...
    def render(self) -> RenderResult:
        ...
        if self.orientation == "vertical":
            ...
            return VerticalRuleRenderable(rule_character, style, self.content_size.height)
        elif self.orientation == "horizontal":
            rule_character = _HORIZONTAL_LINE_CHARS[self.line_style]
            return HorizontalRuleRenderable(rule_character, style, self.content_size.width)
        else:
