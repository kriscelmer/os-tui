...
def default_cell_formatter(obj: object, wrap: bool = True, height: int = 0) -> RenderableType:
...
class DataTable(ScrollView, Generic[CellType], can_focus=True):
    ...
    def __init__(
        ...
        *,
        ...
        self._row_render_cache: LRUCache[RowCacheKey, tuple[SegmentLines, SegmentLines]] = LRUCache(
            1000
        )
        ...
        self._row_renderable_cache: LRUCache[tuple[int, int], RowRenderables] = LRUCache(1000)
    ...
    def render_line(self, y: int) -> Strip:
        ...
        fixed_row_keys: list[RowKey] = [
            self._row_locations.get_key(row_index) for row_index in range(self.fixed_rows)
        ]
