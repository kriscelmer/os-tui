...
"""
    ...
    def _draw_cursor(self) -> bool:
        ...
        draw_cursor = (
            self.has_focus and not self.cursor_blink or (self.cursor_blink and self._cursor_visible)
        )
        return draw_cursor
    ...
    def render_line(self, y: int) -> Strip:
        ...
        cache_key = (
            ...
            (
                selection.end
                if (self._cursor_visible and self.cursor_blink and absolute_y == selection.end[0])
                else None
            ),
            self.theme,
    ...
    def _render_line(self, y: int) -> Strip:
        ...
        draw_matched_brackets = (
            has_cursor and match_cursor_bracket and matching_bracket is not None and start == end
        )
    ...
    def gutter_width(self) -> int:
        ...
        gutter_margin = 2
        gutter_width = (
            len(str(self.document.line_count - 1 + self.line_number_start)) + gutter_margin
            if self.show_line_numbers
            else 0
        )
        return gutter_width
