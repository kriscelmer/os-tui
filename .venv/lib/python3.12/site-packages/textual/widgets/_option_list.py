...
class Option:
    ...
    def __init__(self, prompt: VisualType, id: str | None = None, disabled: bool = False) -> None:
...
class OptionList(ScrollView, can_focus=True):
    ...
    def add_options(self, new_options: Iterable[OptionListContent]) -> Self:
        ...
        if len(option_ids) != len(set(option_ids)):
            raise DuplicateID("New options contain duplicated IDs; Ensure that the IDs are unique.")
    ...
    def get_option(self, option_id: str) -> Option:
        ...
        try:
            ...
            raise OptionDoesNotExist(f"There is no option with an ID of {option_id!r}") from None
    ...
    def _update_lines(self) -> None:
        ...
        if next_index < len(self.options):
            ...
            for index, option in enumerate(self.options[next_index:], next_index):
                ...
                line_cache.lines.extend([(index, line_no) for line_no in range(0, line_count)])
