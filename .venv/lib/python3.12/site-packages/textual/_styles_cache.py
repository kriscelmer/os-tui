...
class StylesCache:
    ...
    def render_widget(self, widget: Widget, crop: Region) -> list[Strip]:
        ...
        if widget.auto_links:
            ...
            if hover_style._link_id and hover_style._meta and "@click" in hover_style.meta:
                ...
                if link_style_hover:
                    strips = [
                        strip.style_links(hover_style.link_id, link_style_hover) for strip in strips
                    ]
    ...
    def render_line(
        ...
        def line_post(segments: Iterable[Segment]) -> Iterable[Segment]:
            ...
            if styles.has_rule("hatch") and styles.hatch != "none":
                ...
                if character != " " and color.a > 0:
                    hatch_style = from_color((background + color).rich_color, background.rich_color)
        ...
        def post(segments: Iterable[Segment]) -> Iterable[Segment]:
            ...
            if styles.tint.a:
                segments = Tint.process_segments(segments, styles.tint, ansi_theme, background)
            if opacity != 1.0:
        ...
        if (border_top and y == 0) or (border_bottom and y == height - 1):
            ...
            if border_label is None:
                ...
                style += Style(
                    ...
                    ((base_label_background + label_color) if label_color.a else TRANSPARENT),
                )
