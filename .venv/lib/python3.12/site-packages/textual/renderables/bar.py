...
class Bar:
    ...
    def __rich_console__(self, console: Console, options: ConsoleOptions) -> RenderResult:
        ...
        output_bar.append(Text(self.BAR * (int(start - 0.5)), style=background_style, end=""))
        ...
        if half_start:
            ...
            highlight_bar.append(Text(self.BAR * bar_width, style=highlight_style, end=""))
        if half_end:
            highlight_bar.append(Text(self.HALF_BAR_RIGHT, style=highlight_style, end=""))
        ...
        for range_name, (start, end) in self.clickable_ranges.items():
            output_bar.apply_meta({"@click": f"range_clicked('{range_name}')"}, start, end)
