...
class Compositor:
            ...
            if widget.is_scrollable:
                ...
                if widget.is_container:
                    ...
                    if widget._anchored and not widget._anchor_released:
                        new_scroll_y = arrange_result.spatial_map.total_region.bottom - (
                    ...
                    layers_to_index = {
                        layer_name: index for index, layer_name in enumerate(widget.layers)
                    }
                    ...
                    for (
                        ...
                        if fixed:
                            widget_region = sub_region + sub_region_offset + placement_offset
                        else:
                            widget_region = sub_region + sub_region_offset + placement_scroll_offset
                ...
                if visible:
                    # Add any scrollbars
                    if (
                        widget.show_vertical_scrollbar or widget.show_horizontal_scrollbar
    ...
    def _get_renders(
        ...
        if crop:
            ...
            widget_regions = [
                (widget, region, clip) for widget, (region, clip) in visible_widgets.items()
            ]
