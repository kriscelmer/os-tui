...
def arrange(
    ...
    for widgets in layers.values():
        ...
        if split_widgets:
            _split_placements, dock_region = _arrange_split_widgets(split_widgets, size, viewport)
        ...
        if layout_widgets:
            ...
            layout_placements = widget.process_layout(
                widget.layout.arrange(widget, layout_widgets, dock_region.size, greedy=not optimal)
            )
...
def _arrange_split_widgets(
    ...
    for split_widget in split_widgets:
        ...
        append_placement(
            _WidgetPlacement(split_region, null_offset, null_spacing, split_widget, 1, True, False)
        )
