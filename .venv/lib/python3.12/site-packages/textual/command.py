...
class SimpleProvider(Provider):
    ...
    def __call__(self, screen: Screen[Any], match_style: Style | None = None) -> SimpleProvider:
        self.__match_style = match_style
        return self
...
class CommandPalette(SystemModalScreen[None]):
    ...
    def _watch__list_visible(self) -> None:
        ...
        self.query_one("#--input", Horizontal).set_class(self._list_visible, "--list-visible")
    ...
    async def _search_for(self, search_value: str) -> AsyncGenerator[DiscoveryHit | Hit, bool]:
    ...
    def _action_cursor_down(self) -> None:
        ...
        elif commands.option_count and not commands.get_option_at_index(0).id == self._NO_MATCHES:
