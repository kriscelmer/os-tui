...
class Driver(ABC):
    ...
    def send_message(self, message: messages.Message) -> None:
        ...
        Args:
            message: A message.
        """
        asyncio.run_coroutine_threadsafe(self._app._post_message(message), loop=self._loop)
    ...
    def process_message(self, message: messages.Message) -> None:
        ...
        if isinstance(message, events.MouseDown):
            ...
            if self._down_buttons and not message.button and self._last_move_event is not None:
                ...
                with open(save_path, mode, encoding=encoding or "utf-8") as destination_file:
                    ...
                    while True:
                        ...
                        if not data:
                            ...
                            self._delivery_complete(delivery_key, save_path=save_path, name=name)
                            break
                        write(data)
